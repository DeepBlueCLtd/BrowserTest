...
The entire runtime MUST fit within a 40KB min+gzip IIFE bundle. Components use Shadow DOM for isolation without global CSS pollution. Session operations complete within 200ms on reference hardware. This constraint ensures the system runs smoothly on older, resource-constrained training machines typical in the deployment environment.
