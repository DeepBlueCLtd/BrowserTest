...
`;function Kt(){return null!==w(E.SESSION)}function Wt(){return"true"===sessionStorage.getItem(E.INSTRUCTOR)}function Jt(t,n,s){const o=[];if(t&&""!==t.trim()||o.push("Name required"),n){/^[a-zA-Z0-9]{2,10}$/.test(n)||o.push("Service ID must be 2-10 alphanumeric characters")}else o.push("Service ID required");if(s){/^\d{4}$/.test(s)||o.push("PIN must be exactly 4 digits")}else o.push("PIN required");return o}const Yt=".wh_top_menu_and_indexterms_link",Gt=".wh_publication_title .title",Zt="",Xt="qd-status-container",en="qd-title-selector",tn="qd-instructor-hash",nn="qd-db-name";function sn(t,n){const s=document.querySelector(`#${t}`);if(!s)return n;const o=s.textContent?.trim()||"";return""===o?(d(`Config element #${t} found but empty, using default: "${n}"`),n):(r(`Config read from #${t}: "${o}"`),o)}function on(){r("Reading configuration from DOM...");const t=function(t){const n=document.querySelector(`#${t}`);if(!n){const n=`FATAL: Required config element #${t} not found in DOM. Processing stopped.`;throw console.error(n),new Error(n)}const s=n.textContent?.trim()||"";if(""===s){const n=`FATAL: Required config element #${t} is empty. Processing stopped.`;throw console.error(n),new Error(n)}return r(`Required config read from #${t}: "${s}"`),s}(nn),n={statusPanelContainer:sn(Xt,Yt),titleSelector:sn(en,Gt),instructorHash:sn(tn,Zt),dbName:t};return r("Configuration loaded:",n),n}function rn(){const t=document.querySelector(`#${nn}`);return t?.textContent?.trim()||""}function an(){const t=document.querySelector(sn(en,Gt));return t?.textContent?.trim()||""}async function dn(t){const n=(new TextEncoder).encode(t),s=await crypto.subtle.digest("SHA-256",n);return Array.from(new Uint8Array(s)).map(t=>t.toString(16).padStart(2,"0")).join("")}function cn(t){return`${E.PIN_ATTEMPTS}:${t}`}function ln(t){const n=cn(t),s=sessionStorage.getItem(n);if(!s)return null;try{return JSON.parse(s)}catch{return null}}function un(t){const n=ln(t);if(!n||!n.lockoutUntil)return{isLocked:!1,remainingMs:0};const s=new Date(n.lockoutUntil).getTime(),o=Date.now();return s>o?{isLocked:!0,remainingMs:s-o}:(hn(t),{isLocked:!1,remainingMs:0})}function hn(t){const n=ln(t);n&&n.attempts>0&&r(`Cleared ${n.attempts} failed PIN attempts for ${s(t)} on successful login`);const o=cn(t);sessionStorage.removeItem(o)}function pn(t){const n=ln(t);if(!n)return q;return un(t).isLocked?0:Math.max(0,q-n.attempts)}class AuthService{loginStudent(t){return this.runLogin(t,{checkLock:!0,surfaceMigration:!0,errorMessage:"Login failed. Please try again.",errorLabel:"Student login error:"})}retryAfterMigration(t){return this.runLogin(t,{checkLock:!1,surfaceMigration:!1,errorMessage:"Login failed after migration. Please try again.",errorLabel:"Post-migration login error:"})}async runLogin(t,n){const{serviceId:o,name:a,pin:c,release:l,dbName:u}=t;if(n.checkLock){const t=un(o);if(t.isLocked)return{kind:"lockout",lockoutMs:t.remainingMs}}try{const t=ne(u);await t.init();const n=await t.getStudent(l,o);if(n){if(n.schema<2||!function(t){return Boolean(t.pinHash&&t.pinHash.length>0)}(n)){const s=function(t,n){return{...t,schema:2,pinHash:n,pinCreatedAt:(new Date).toISOString()}}(n,await dn(c));return await t.saveStudent(s),{kind:"pin-created",serviceId:o,name:a,release:l}}const u=await async function(t,n){return function(t,n){if(t.length!==n.length)return!1;let s=0;for(let o=0;o<t.length;o++)s|=t.charCodeAt(o)^n.charCodeAt(o);return 0===s}(await dn(t),n)}(c,n.pinHash||"");if(!u){const t=function(t){const n=(new Date).toISOString();let o=ln(t);if(o||(o={serviceId:t,attempts:0,lockoutUntil:null,lastAttempt:n}),o.attempts+=1,o.lastAttempt=n,o.attempts>=q){const n=new Date(Date.now()+C);o.lockoutUntil=n.toISOString(),d(`PIN lockout triggered for ${s(t)} after ${o.attempts} failed attempts`)}else r(`Failed PIN attempt ${o.attempts}/${q} for ${s(t)}`);const a=cn(t);return sessionStorage.setItem(a,JSON.stringify(o)),o}(o);if(t.lockoutUntil){return{kind:"lockout",lockoutMs:new Date(t.lockoutUntil).getTime()-Date.now()}}return{kind:"bad-pin",remaining:pn(o)}}return hn(o),{kind:"pin-verified",serviceId:o,name:a,release:l}}const h=await dn(c),p={schema:2,docId:"",release:l,serviceId:o,name:a,attempted:0,correct:0,updated:(new Date).toISOString(),pages:{},pinHash:h,pinCreatedAt:(new Date).toISOString()};return await t.saveStudent(p),{kind:"pin-created",serviceId:o,name:a,release:l}}catch(h){return n.surfaceMigration&&h instanceof StorageFormatError?{kind:"needs-migration",error:h}:(console.error(n.errorLabel,h),{kind:"error",message:n.errorMessage})}}}var gn=Object.getOwnPropertyDescriptor;let mn=class extends ht{render(){return tt`
  ...
  `,mn=((t,n,s,o)=>{for(var r,a=o>1?void 0:o?gn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=r(a)||a);return a})([gt("qd-build-info")],mn);class RateLimiter{constructor(t=0){this.freeFailures=t,this.failureCount=0,this.lockoutUntil=null}attempt(){return!(this.lockoutUntil&&Date.now()<this.lockoutUntil)&&(this.lockoutUntil&&Date.now()>=this.lockoutUntil&&(this.lockoutUntil=null),!0)}recordFailure(){if(this.failureCount++,this.failureCount<=this.freeFailures)return;const t=[2e3,4e3,8e3,16e3,3e4],n=t[Math.min(this.failureCount-this.freeFailures-1,t.length-1)]??3e4;this.lockoutUntil=Date.now()+n}reset(){this.failureCount=0,this.lockoutUntil=null}getRemainingSeconds(){if(!this.lockoutUntil)return 0;const t=Math.max(0,this.lockoutUntil-Date.now());return Math.ceil(t/1e3)}isLockedOut(){return null!==this.lockoutUntil&&Date.now()<this.lockoutUntil}}async function fn(t,n){if(t.length!==n.length)return!1;if(0===t.length)return!0;const s=new TextEncoder,o=s.encode(t),r=s.encode(n);try{const t=await crypto.subtle.importKey("raw",o,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),n=await crypto.subtle.sign("HMAC",t,r),s=await crypto.subtle.importKey("raw",r,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),a=await crypto.subtle.sign("HMAC",s,o);if(n.byteLength!==a.byteLength)return!1;const d=new Uint8Array(n),c=new Uint8Array(a);let l=0;for(let o=0;o<d.length;o++)l|=(d[o]??0)^(c[o]??0);return 0===l}catch(a){return console.error("Constant-time comparison failed:",a),!1}}async function bn(t){const n=(new TextEncoder).encode(t),s=await crypto.subtle.digest("SHA-256",n);return Array.from(new Uint8Array(s)).map(t=>t.toString(16).padStart(2,"0")).join("").substring(0,12)}function yn(){const t=document.getElementById(tn);return t?.textContent?.trim()||""}async function vn(t){const n=yn();if(!n)return!1;return fn(await bn(t),n)}var wn=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,Sn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?xn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&wn(n,s,a),a};const $n="__qdModalCurrentRef__";function En(){return globalThis[$n]??null}function qn(t){globalThis[$n]=t}let Cn=class extends ht{constructor(){super(...arguments),this.open=!1,this.closable=!0,this.previouslyFocused=null,this.originalParent=null,this.originalNextSibling=null,this.isInBody=!1,this.handleKeyDown=t=>{"Escape"===t.key&&this.open&&this.closable&&(this.emitCloseEvent(),this.close())},this.handleBackdropClick=()=>{this.closable&&(this.emitCloseEvent(),this.close())},this.handleCloseClick=()=>{this.emitCloseEvent(),this.close()},this.stopPropagation=t=>{t.stopPropagation()}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleKeyDown),En()!==this||this.isInBody||qn(null)}updated(t){t.has("open")&&(this.open?this.handleOpen():this.handleClose())}moveToBody(){this.isInBody||(this.originalParent=this.parentNode,this.originalNextSibling=this.nextSibling,this.isInBody=!0,document.body.appendChild(this))}restorePosition(){this.isInBody&&this.originalParent&&(this.originalNextSibling?this.originalParent.insertBefore(this,this.originalNextSibling):this.originalParent.appendChild(this),this.originalParent=null,this.originalNextSibling=null,this.isInBody=!1)}render(){return tt`
    ...
    `}show(){this.open=!0}close(){this.open=!1}handleOpen(){const t=En();t&&t!==this&&t.close(),qn(this),this.previouslyFocused=document.activeElement,this.moveToBody(),requestAnimationFrame(()=>{this.focusFirstElement()})}handleClose(){En()===this&&qn(null),this.restorePosition(),this.previouslyFocused instanceof HTMLElement&&this.previouslyFocused.focus()}focusFirstElement(){const t=this.shadowRoot?.querySelector(".content");if(!t)return;const n=this.shadowRoot?.querySelector("slot:not([name])");if(n){const t=n.assignedElements({flatten:!0});for(const n of t){const t=n.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');if(t)return void t.focus();if(n instanceof HTMLElement&&n.matches('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'))return void n.focus()}}const s=this.shadowRoot?.querySelector(".close-button");s&&s.focus()}emitCloseEvent(){const t=new CustomEvent("qd:modal-close",{bubbles:!0,composed:!0});this.dispatchEvent(t)}};Cn.styles=ve`
    :host {
      display: contents;
    }
  ...
  `,An([bt({type:Boolean,reflect:!0})],On.prototype,"open",2),An([bt({type:String})],On.prototype,"title",2),An([bt({type:String})],On.prototype,"error",2),An([yt()],On.prototype,"password",2),An([vt('input[type="password"]')],On.prototype,"passwordInput",2),On=An([gt("qd-password-modal")],On);var Pn=Object.defineProperty,Tn=Object.getOwnPropertyDescriptor,Ln=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Tn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Pn(n,s,a),a};let Nn=class extends ht{constructor(){super(...arguments),this.disabled=!1,this.showModal=!1,this.error="",this.rateLimiter=new RateLimiter(q-1),this.open=()=>{this.showModal=!0,this.error=""},this.handleClose=()=>{this.showModal=!1,this.error=""},this.handleSubmit=t=>{this.login(t.detail.password)}}render(){return tt`
  ...
  `,Ln([bt({type:Boolean})],Nn.prototype,"disabled",2),Ln([yt()],Nn.prototype,"showModal",2),Ln([yt()],Nn.prototype,"error",2),Nn=Ln([gt("qd-instructor-login")],Nn);var _n=Object.defineProperty,Dn=Object.getOwnPropertyDescriptor,zn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Dn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&_n(n,s,a),a};let Mn=class extends ht{constructor(){super(...arguments),this.untilMs=0,this.seconds=0,this.interval=null}disconnectedCallback(){super.disconnectedCallback(),this.clearTimer()}willUpdate(t){if(t.has("untilMs")){const t=this.untilMs-Date.now();this.seconds=t>0?Math.ceil(t/1e3):0}}updated(t){t.has("untilMs")&&this.startTimer()}render(){return this.seconds<=0?tt``:tt`<div class="lockout-message" role="alert" aria-live="polite" aria-atomic="true">
      Too many attempts. Try again in ${this.seconds}s
    </div>`}startTimer(){this.clearTimer(),this.seconds<=0||(this.interval=window.setInterval(()=>{this.seconds--,this.seconds<=0&&(this.clearTimer(),this.dispatchEvent(new CustomEvent("qd:lockout-expired",{bubbles:!0,composed:!0})))},1e3))}clearTimer(){this.interval&&(clearInterval(this.interval),this.interval=null)}};Mn.styles=ve`
    .lockout-message {
      width: 100%;
      color: #f57c00;
      font-size: 11px;
  ...
  `,zn([bt({type:Number})],Mn.prototype,"untilMs",2),zn([yt()],Mn.prototype,"seconds",2),Mn=zn([gt("qd-lockout-banner")],Mn);
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */
const Rn=2;class i{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,s){this._$Ct=t,this._$AM=n,this._$Ci=s}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}}
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class e extends i{constructor(t){if(super(t),this.it=st,t.type!==Rn)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===st||null==t)return this._t=void 0,this.it=t;if(t===nt)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}e.directiveName="unsafeHTML",e.resultType=1;const Hn=(t=>(...n)=>({_$litDirective$:t,values:n}))(e);var Un=Object.defineProperty,jn=Object.getOwnPropertyDescriptor,Bn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?jn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Un(n,s,a),a};let Fn=class extends ht{constructor(){super(...arguments),this.open=!1,this.title="Confirm",this.message="",this.confirmText="Confirm",this.cancelText="Cancel",this.destructive=!1,this.handleModalClose=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:cancel",{bubbles:!0,composed:!0}))},this.handleConfirm=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:confirm",{bubbles:!0,composed:!0}))},this.handleCancel=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:cancel",{bubbles:!0,composed:!0}))}}show(){this.open=!0}close(){this.open=!1}render(){return tt`
      <qd-modal .open=${this.open} @qd:modal-close=${this.handleModalClose}>
        <span slot="header">${this.title}</span>

        <div class="confirm-content">
          <div class="message">${Hn(this.message)}</div>
  ...
  `,Bn([bt({type:Boolean,reflect:!0})],Fn.prototype,"open",2),Bn([bt({type:String})],Fn.prototype,"title",2),Bn([bt({type:String})],Fn.prototype,"message",2),Bn([bt({type:String})],Fn.prototype,"confirmText",2),Bn([bt({type:String})],Fn.prototype,"cancelText",2),Bn([bt({type:Boolean})],Fn.prototype,"destructive",2),Fn=Bn([gt("qd-confirm-dialog")],Fn);var Vn=Object.defineProperty,Qn=Object.getOwnPropertyDescriptor,Kn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Qn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Vn(n,s,a),a};let Wn=class extends ht{constructor(){super(...arguments),this.panelType="login",this.handleClick=()=>{this.dispatchEvent(new CustomEvent("qd:help-open",{detail:{panelType:this.panelType},bubbles:!0,composed:!0}))}}render(){return tt`
...
`;var os=Object.getOwnPropertyDescriptor;let rs=class extends ht{render(){return tt`<div class="spinner" role="status" aria-label="Loading"></div>`}};rs.styles=[ss],rs=((t,n,s,o)=>{for(var r,a=o>1?void 0:o?os(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=r(a)||a);return a})([gt("qd-spinner")],rs);var is=Object.defineProperty,as=Object.getOwnPropertyDescriptor,ds=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?as(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&is(n,s,a),a};let cs=class extends ht{constructor(){super(...arguments),this.open=!1,this.expected="plain",this.found="plain",this.dbName="",this.releaseId="",this.dialogState="password",this.password="",this.error="",this.migrationResult=null,this.handleModalClose=()=>{this.dispatchEvent(new CustomEvent("qd:migration-cancel",{bubbles:!0,composed:!0}))},this.handleInput=t=>{const n=t.target;this.password=n.value,this.error&&(this.error="")},this.handleSubmit=async t=>{if(t.preventDefault(),!this.password.trim())return;await this.validatePassword(this.password)?await this.runMigration():this.error||(this.error="Incorrect instructor password")},this.handleContinue=()=>{this.dispatchEvent(new CustomEvent("qd:migration-complete",{detail:this.migrationResult,bubbles:!0,composed:!0}))},this.handleCancel=()=>{this.dispatchEvent(new CustomEvent("qd:migration-cancel",{bubbles:!0,composed:!0}))}}updated(t){t.has("open")&&this.open&&(this.dialogState="password",this.password="",this.error="",this.migrationResult=null,this.updateComplete.then(()=>{this.passwordInput?.focus()}))}async validatePassword(t){return yn()?vn(t):(this.error="Instructor password not configured",!1)}async runMigration(){this.dialogState="migrating",this.error="";try{const t="decrypt",n=await es(this.dbName,t,{releaseId:this.releaseId,dryRun:!1});if(n.errors.length>0)return this.dialogState="error",void(this.error=`Migration completed with ${n.errors.length} error(s). Some records may not have been migrated.`);this.migrationResult={migrated:n.migrated,skipped:n.skipped},this.dialogState="success"}catch(t){this.dialogState="error",this.error=`Migration failed: ${t instanceof Error?t.message:"Unknown error"}`}}render(){return tt`
      <qd-modal .open=${this.open} @qd:modal-close=${this.handleModalClose}>
  ...
  `,ys([yt()],vs.prototype,"total",2),ys([yt()],vs.prototype,"correct",2),ys([yt()],vs.prototype,"percentage",2),ys([yt()],vs.prototype,"statusColor",2),ys([yt()],vs.prototype,"name",2),ys([yt()],vs.prototype,"serviceId",2),ys([yt()],vs.prototype,"helpOpen",2),vs=ys([gt("qd-status")],vs);const ws=ve`
  :host {
    display: inline-block;
    font-family:
      system-ui,
...
`;var xs=Object.defineProperty,Ss=Object.getOwnPropertyDescriptor,$s=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Ss(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&xs(n,s,a),a};let Es=class extends ht{constructor(){super(...arguments),this.password="",this.error="",this.remainingSeconds=0,this.rateLimiter=new RateLimiter(q-1),this.handlePasswordInput=t=>{const n=t.target;this.password=n.value,this.error=""},this.handleSubmit=async t=>{t.preventDefault();if(!this.rateLimiter.attempt())return this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),this.startCountdown(),void(this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`);try{const t=yn();if(!t)throw new Error("Instructor password hash not configured");const n=await bn(this.password);await fn(n,t)?(this.rateLimiter.reset(),this.password="",this.error="",ce(this,"qd:instructor-unlock",{})):(this.rateLimiter.recordFailure(),this.error="Invalid password",this.password="")}catch{this.error="Authentication failed",this.password=""}}}disconnectedCallback(){super.disconnectedCallback(),this.countdownInterval&&window.clearInterval(this.countdownInterval)}startCountdown(){this.countdownInterval&&window.clearInterval(this.countdownInterval),this.countdownInterval=window.setInterval(()=>{this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),0===this.remainingSeconds?(this.countdownInterval&&(window.clearInterval(this.countdownInterval),this.countdownInterval=void 0),this.error=""):this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`},1e3)}render(){const t=this.remainingSeconds>0;return tt`
    ...
    `}};Es.styles=ws,$s([yt()],Es.prototype,"password",2),$s([yt()],Es.prototype,"error",2),$s([yt()],Es.prototype,"remainingSeconds",2),Es=$s([gt("qd-instructor-unlock")],Es);var qs=Object.defineProperty,Cs=Object.getOwnPropertyDescriptor,Is=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Cs(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&qs(n,s,a),a};let ks=class extends ht{constructor(){super(...arguments),this.open=!1,this.students=[],this.handleModalClose=()=>{this.open=!1,this.dispatchEvent(new CustomEvent("close"))}}render(){return tt`
      <qd-modal .open=${this.open} @qd:modal-close=${this.handleModalClose}>
  ...
  `,Ws([bt({type:Array})],Js.prototype,"students",2),Ws([bt({type:Boolean,reflect:!0})],Js.prototype,"open",2),Ws([yt()],Js.prototype,"confirmingStudent",2),Ws([yt()],Js.prototype,"confirmDialogOpen",2),Ws([yt()],Js.prototype,"errorMessage",2),Ws([bt({type:Boolean})],Js.prototype,"showModal",1),Js=Ws([gt("qd-pin-reset-dialog")],Js);var Ys=Object.defineProperty,Gs=Object.getOwnPropertyDescriptor,Zs=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Gs(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Ys(n,s,a),a};let Xs=class extends ht{constructor(){super(...arguments),this.unlocked=!1,this.showScores=!1,this.students=[],this.showStudentAnswers=!1,this.showPinReset=!1,this.helpOpen=!1,this.handleLoginEvent=t=>{const n=t,s=n.detail?.role;this.updateVisibility(),"instructor"===s&&(this.unlock(),this.refreshStudents())},this.handleLogoutEvent=()=>{this.updateVisibility(),this.lock()},this.handleResetPins=async()=>{await this.refreshStudents(),this.showPinReset=!0},this.handleClosePinReset=()=>{this.showPinReset=!1},this.handlePinReset=()=>{this.dispatchEvent(new CustomEvent("qd:pin-reset",{bubbles:!0,composed:!0}))},this.handleUnlock=()=>{this.unlocked=!0,this.dispatchEvent(new CustomEvent("qd:instructor-unlock",{bubbles:!0,composed:!0}))},this.handleViewScores=async()=>{await this.refreshStudents(),this.showScores=!0},this.handleCloseScores=()=>{this.showScores=!1},this.handleDataCleared=()=>{this.dispatchEvent(new CustomEvent("qd:data-cleared",{bubbles:!0,composed:!0})),this.students=[]},this.handleLogout=()=>{const t=w(E.SESSION);(new SessionService).clearSession(),this.dispatchEvent(new CustomEvent("qd:logout",{detail:{serviceId:t?.serviceId||"unknown"},bubbles:!0,composed:!0}))},this.handleToggleStudentAnswers=async t=>{const n=t.target;this.showStudentAnswers=n.checked,this.showStudentAnswers&&0===this.students.length&&await this.refreshStudents();const s=this.showStudentAnswers?"qd:instructor-show-answers":"qd:instructor-hide-answers";this.dispatchEvent(new CustomEvent(s,{bubbles:!0,composed:!0})),sessionStorage.setItem(v,String(this.showStudentAnswers))},this.handleHelpOpen=()=>{this.helpOpen=!0},this.handleHelpClose=()=>{this.helpOpen=!1}}connectedCallback(){super.connectedCallback(),this.updateVisibility();const t=Wt();t&&(this.unlock(),this.refreshStudents());const n=sessionStorage.getItem(v);null!==n&&(this.showStudentAnswers="true"===n,this.showStudentAnswers&&t&&setTimeout(()=>{this.dispatchEvent(new CustomEvent("qd:instructor-show-answers",{bubbles:!0,composed:!0}))},100)),document.addEventListener("qd:login",this.handleLoginEvent),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:login",this.handleLoginEvent),document.removeEventListener("qd:logout",this.handleLogoutEvent)}updateVisibility(){this.toggleAttribute("data-show",Wt())}setStudents(t){this.students=t}async refreshStudents(){const t=w(E.SESSION);if(t)try{const n=ae();this.students=await n.getStudentsByRelease(t.release)}catch(n){console.error("Failed to load students:",n),this.students=[]}}unlock(){this.unlocked=!0}lock(){this.unlocked=!1,this.showScores=!1,this.showPinReset=!1}render(){return this.unlocked?tt`
      <div class="instructor-panel">
        ...
        <qd-help-popup
          .open=${this.helpOpen}
          .title=${us("instructor").title}
          .content=${us("instructor").body}
          @qd:modal-close=${this.handleHelpClose}
        ></qd-help-popup>
      </div>
    `:tt`
    ...
    `],Zs([yt()],Xs.prototype,"unlocked",2),Zs([yt()],Xs.prototype,"showScores",2),Zs([yt()],Xs.prototype,"students",2),Zs([yt()],Xs.prototype,"showStudentAnswers",2),Zs([yt()],Xs.prototype,"showPinReset",2),Zs([yt()],Xs.prototype,"helpOpen",2),Xs=Zs([gt("qd-instructor")],Xs);const eo={statusPanel:".wh_top_menu_and_indexterms_link"};function to(t={}){const n=t.statusPanelContainer||eo.statusPanel;!function(t){const n=document.querySelector(t);if(!n)return r(`Login component not injected: container '${t}' not found`),null;const s=document.createElement("qd-login");n.appendChild(s),r("Login component injected")}(n),function(t){const n=document.querySelector(t);if(!n)return r(`Status component not injected: container '${t}' not found`),null;const s=document.createElement("qd-status");n.appendChild(s),r("Status component injected")}(n),function(t){const n=document.querySelector(t);if(!n)return r(`Instructor component not injected: container '${t}' not found`),null;const s=document.createElement("qd-instructor");n.appendChild(s),r("Instructor component injected")}(n)}const no={red:"qd-badge-red",amber:"qd-badge-amber",green:"qd-badge-green"},so={unstarted:"red",incomplete:"amber",complete:"green"};function oo(t){Object.values(no).forEach(n=>{t.classList.remove(n)})}function ro(t){const n=function(t,n){if(!t||!n?.pages)return"unstarted";const s=n.pages[t];return s?.state??"unstarted"}(t.getAttribute("data-page-id"),w(E.CACHE));!function(t,n){oo(t);const s=no[so[n]];t.classList.add(s)}(t,n)}function io(){const t=document.querySelectorAll(".quizPageBtn"),n=w(E.CACHE),s="true"===sessionStorage.getItem(E.INSTRUCTOR);if(!n||s)return t.forEach(t=>{oo(t)}),void r(s?`Removed badge styling from ${t.length} page links (instructor mode)`:`Removed badge styling from ${t.length} page links (no session)`);t.forEach(t=>{ro(t)}),r(`Updated ${t.length} page badges`)}function ao(t){const n=t,{pageId:s}=n.detail,o=document.querySelector(`[data-page-id="${s}"]`);o&&o.classList.contains("quizPageBtn")&&(ro(o),r(`Updated badge for page ${s}`))}function co(){r("Cache rebuilt, refreshing all badges"),io()}function lo(){r("Logout detected, removing all badge styling");const t=document.querySelectorAll(".quizPageBtn");t.forEach(t=>{oo(t)}),r(`Removed badge styling from ${t.length} page links`)}const uo={initialized:!1};async function ho(t={}){if(uo.initialized)return void d("Bootstrap already initialized, skipping");if(r("Bootstrapping Sonar Quiz System..."),function(){if(document.getElementById("qd-global-styles"))return;const t=document.createElement("style");t.id="qd-global-styles",t.textContent="\n    /* Sonar Quiz System - Global Styles */\n    .qd-hidden {\n      display: none !important;\n    }\n\n    /* Quiz table interactive mode styles */\n    .qd-quiz-interactive .qd-quiz-input {\n      width: 100%;\n      padding: 0.5rem;\n      font-size: inherit;\n      border: 1px solid #ccc;\n      border-radius: 4px;\n    }\n\n    /* Ensure select elements inherit font properly */\n    .qd-quiz-interactive select.qd-quiz-input {\n      font-family: inherit;\n      font-size: inherit;\n    }\n\n    /* Validation styling for answer cells */\n    .qd-quiz-interactive .qd-answer-correct {\n      background-color: #d4edda !important;\n      border-color: #28a745 !important;\n    }\n\n    .qd-quiz-interactive .qd-answer-incorrect {\n      background-color: #f8d7da !important;\n      border-color: #dc3545 !important;\n    }\n\n    /* Home page badge styles (R/A/G indicators) */\n    .qd-badge-red {\n      border-left: 4px solid #d32f2f !important;\n      background-color: #ffebee !important;\n    }\n\n    .qd-badge-amber {\n      border-left: 4px solid #ff9800 !important;\n      background-color: #fff3e0 !important;\n    }\n\n    .qd-badge-green {\n      border-left: 4px solid #4caf50 !important;\n      background-color: #e8f5e9 !important;\n    }\n\n    /* Instructor-mode student answers/entries are now rendered by the\n       Shadow-DOM <qd-student-answers> / <qd-student-entries> components, which\n       own their styles. No global rules are needed here. */\n\n    /* Modal error message styles (needed because qd-modal moves to body) */\n    .error-message {\n      color: #d32f2f;\n      font-size: 12px;\n      padding: 8px;\n      background: #ffebee;\n      border-radius: 4px;\n      border-left: 3px solid #d32f2f;\n    }\n  ",document.head.appendChild(t),r("Global styles injected")}(),!t.dbName){const t="FATAL: dbName not provided in bootstrap config. Processing stopped.";throw console.error(t),new Error(t)}const n=ae(t.dbName);await n.init();const s=new EventCoordinator;s.initialize(),uo.eventCoordinator=s;const o=new SessionCoordinator;o.initialize(),uo.sessionCoordinator=o,to({statusPanelContainer:t.statusPanelContainer,dbName:t.dbName}),!1!==t.autoEnhanceQuizTables&&po("table.qd-quiz","quiz",t=>It(t,{interactive:!1})),!1!==t.autoEnhanceAnalysisTables&&po("table.qd-analysis","analysis",t=>jt(t,{interactive:!1})),!1!==t.autoEnhanceHomeBadges&&function(){const t=document.querySelectorAll(".quizPageBtn");if(0===t.length)return void r("No .quizPageBtn links found, skipping badge enhancement");r(`Enhancing home page badges for ${t.length} link(s)...`);try{document.querySelectorAll(".quizPageBtn").forEach(t=>{const n=function(t){const n=t.getAttribute("href");return n&&n.substring(n.lastIndexOf("/")+1).replace(/\.html?$/i,"")||null}(t);n?(t.setAttribute("data-page-id",n),r(`Set data-page-id="${n}" for link: ${t.textContent?.trim()}`)):r(`Failed to extract pageId from href: ${t.getAttribute("href")}`)}),io(),document.addEventListener("qd:state-changed",ao),document.addEventListener("qd:cache-rebuild",co),document.addEventListener("qd:logout",lo),r("Home page badges enhanced with event listeners"),r("Home page badges enhanced")}catch(n){d(`Failed to enhance home badges: ${n.message}`)}}(),await async function(){if("true"===sessionStorage.getItem(E.INSTRUCTOR))return r("Instructor session detected, revealing answers in non-interactive tables"),void go();const t=w(E.SESSION);if(!t)return void r("No existing session, tables remain in non-interactive mode");r(`Existing session detected for ${t.serviceId}, upgrading tables to interactive mode`);const n=ae();let s=w(E.CACHE);if(!s){r("Cache not found, rebuilding from IndexedDB...");try{const o=await n.loadStudentRecord(t);s=n.buildCache(o),x(E.CACHE,s),r(`Cache rebuilt from IndexedDB: ${s.totals.total} total questions`)}catch{d("Failed to rebuild cache from IndexedDB, using empty cache"),s={totals:{total:0,answered:0,correct:0},pages:{}},x(E.CACHE,s)}}const o=Ft();if(!o)return void r("No pageId found, skipping table upgrade");const a=document.querySelectorAll("table.qd-quiz");a.length>0&&(r(`Upgrading ${a.length} quiz table(s) to interactive mode...`),a.forEach(t=>{It(t,{interactive:!0,pageId:o})}));const c=document.querySelectorAll("table.qd-analysis");c.length>0&&(r(`Upgrading ${c.length} analysis table(s) to interactive mode...`),c.forEach(t=>{jt(t,{interactive:!0,pageId:o})}))}(),document.addEventListener("qd:login",t=>{const n=t.detail;"instructor"===n?.role&&(r("Instructor login event received, revealing quiz answers"),go())}),uo.initialized=!0,r("Bootstrap complete")}function po(t,n,s){const o=document.querySelectorAll(t);if(0===o.length)return void r(`No ${n} tables found to enhance`);r(`Enhancing ${o.length} ${n} table(s) in non-interactive mode...`);let a=0;for(const r of Array.from(o))try{s(r),a++}catch(c){d(`Failed to enhance ${n} table: ${c.message}`)}r(`Enhanced ${a} of ${o.length} ${n} table(s) (non-interactive)`)}function go(){const t=Ft(),n=document.querySelectorAll("table.qd-quiz");0!==n.length?(n.forEach(n=>{const s=kt(n);s&&(s.pageId=t,Bt(n,s,{addInstructorClass:!0}))}),r(`Revealed answers for instructor on ${n.length} quiz table(s)`)):r("No quiz tables found to reveal answers for")}if("undefined"!=typeof window){const t=()=>{r("Auto-initializing Sonar Quiz System");const t=on();ho({dbName:t.dbName,statusPanelContainer:t.statusPanelContainer,autoEnhanceQuizTables:!0,autoEnhanceAnalysisTables:!0,autoEnhanceHomeBadges:!0}).catch(t=>{console.error("[FATAL] Bootstrap failed:",t)})};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{t()}):t()}return t.BUILD_DATE="5/Sep/2026",t.DEFAULT_CONTAINERS=eo,t.Debouncer=Debouncer,t.OBFUSCATION_PREFIX=K,t.SCHEMA_VERSION=2,t.SESSION_TIMEOUT_MS=$,t.STORAGE_KEYS=E,t.VERSION="0.2.0",t.bootstrap=ho,t.calculateCompletionState=se,t.cleanup=function(){uo.initialized?(r("Cleaning up bootstrap resources..."),uo.eventCoordinator?.cleanup(),uo.sessionCoordinator?.cleanup(),uo.initialized=!1,uo.eventCoordinator=void 0,uo.sessionCoordinator=void 0,r("Bootstrap cleanup complete")):d("Bootstrap not initialized, nothing to cleanup")},t.clearQuizData=S,t.decode=Z,t.deriveKey=W,t.encode=G,t.enhanceAnalysisTable=jt,t.enhanceQuizTable=It,t.error=a,t.generateCellKey=Pt,t.generateTableId=Ot,t.getAnalysisTableMetadata=function(t){return Ut.get(t)},t.getJSON=w,t.getQuizTableMetadata=kt,t.info=r,t.injectComponents=to,t.isAnalysisTableEnhanced=function(t){return Ut.has(t)},t.isCellEditable=Tt,t.isInitialized=function(){return uo.initialized},t.isObfuscated=X,t.isQuizTableEnhanced=function(t){return Ct.has(t)},t.migrateObfuscation=es,t.parseAnalysisTable=Lt,t.parseQuizTable=c,t.setDebugMode=function(t){n=t},t.setJSON=x,t.validateAnswer=l,t.warn=d,Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),t}({});
