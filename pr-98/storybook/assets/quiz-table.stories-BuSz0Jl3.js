import{x as n}from"./lit-element-DR9D0stx.js";import{e as u}from"./quiz-table-D1VjorQw.js";import{S as d}from"./storage-helpers-D_wcwu-v.js";import"./date-helpers-BybTNUJN.js";import"./dom-helpers-CAaP8i-_.js";import"./logger-DdbYlyfi.js";import"./property-BRFVFa-w.js";const C={title:"Enhancers/Quiz Table",tags:["autodocs"],parameters:{docs:{description:{component:"Single-phase quiz table enhancement. Shows non-interactive (pre-login) and interactive (post-login) modes."}}}},g=()=>n`
  <table class="qd-quiz">
    <thead>
      <tr>
        <th>Question</th>
...
Interactive demo showing state progression from unstarted → incomplete → complete`,...c.parameters?.docs?.description}}};const Q=["NonInteractiveMode","InteractiveMCQ","InteractiveNumeric","WithExistingAnswers","StateProgression"];export{a as InteractiveMCQ,i as InteractiveNumeric,o as NonInteractiveMode,c as StateProgression,l as WithExistingAnswers,Q as __namedExportsOrder,C as default};
