/**
 * Storybook stories for Combined Table Enhancement
 *
 * Demonstrates analysis table + quiz table on the same page.
 * This represents the real-world use case where instructors verify
 * student analysis work with follow-up quiz questions.
 */
...
const meta: Meta = {
  title: 'Enhancers/Combined Tables',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
 ...
 * This is the typical instructor-created page structure.
 */
export const AnalysisAndQuiz: Story = {
  render: () => {
    setupSession();
...
/**
 * Combined: With Pre-filled Data
 *
 * Shows both tables loading existing data from cache.
 * Demonstrates that analysis and quiz data coexist properly.
 */
export const WithExistingData: Story = {
  render: () => {
    ...
    existingCache.pages['combined-page-2'] = {
      ...
      correct: 1,
      answers: [
        { answer: '2', success: true, timestamp: new Date().toISOString() },
