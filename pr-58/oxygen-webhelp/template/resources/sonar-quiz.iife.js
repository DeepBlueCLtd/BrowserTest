...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
const xe=globalThis,$e=xe.trustedTypes,Ee=$e?$e.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ce="$lit$",Ae=`lit$${Math.random().toFixed(9).slice(2)}$`,Ie="?"+Ae,qe=`<${Ie}>`,ke=document,_e=()=>ke.createComment(""),De=e=>null===e||"object"!=typeof e&&"function"!=typeof e,Ne=Array.isArray,Te="[ \t\n\f\r]",Oe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Pe=/-->/g,ze=/>/g,Le=RegExp(`>|${Te}(?:([^\\s"'>=/]+)(${Te}*=${Te}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),Re=/'/g,Ue=/"/g,Me=/^(?:script|style|textarea|title)$/i,Be=(Qe=1,(e,...t)=>({_$litType$:Qe,strings:e,values:t})),je=Symbol.for("lit-noChange"),He=Symbol.for("lit-nothing"),Fe=new WeakMap,Ve=ke.createTreeWalker(ke,129);var Qe;function Ge(e,t){if(!Ne(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==Ee?Ee.createHTML(t):t}class N{constructor({strings:e,_$litType$:t},n){let s;this.parts=[];let r=0,o=0;const a=e.length-1,c=this.parts,[d,l]=((e,t)=>{const n=e.length-1,s=[];let r,o=2===t?"<svg>":3===t?"<math>":"",a=Oe;for(let c=0;c<n;c++){const t=e[c];let n,d,l=-1,u=0;for(;u<t.length&&(a.lastIndex=u,d=a.exec(t),null!==d);)u=a.lastIndex,a===Oe?"!--"===d[1]?a=Pe:void 0!==d[1]?a=ze:void 0!==d[2]?(Me.test(d[2])&&(r=RegExp("</"+d[2],"g")),a=Le):void 0!==d[3]&&(a=Le):a===Le?">"===d[0]?(a=r??Oe,l=-1):void 0===d[1]?l=-2:(l=a.lastIndex-d[2].length,n=d[1],a=void 0===d[3]?Le:'"'===d[3]?Ue:Re):a===Ue||a===Re?a=Le:a===Pe||a===ze?a=Oe:(a=Le,r=void 0);const h=a===Le&&e[c+1].startsWith("/>")?" ":"";o+=a===Oe?t+qe:l>=0?(s.push(n),t.slice(0,l)+Ce+t.slice(l)+Ae+h):t+Ae+(-2===l?c:h)}return[Ge(e,o+(e[n]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),s]})(e,t);if(this.el=N.createElement(d,n),Ve.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(s=Ve.nextNode())&&c.length<a;){if(1===s.nodeType){if(s.hasAttributes())for(const e of s.getAttributeNames())if(e.endsWith(Ce)){const t=l[o++],n=s.getAttribute(e).split(Ae),a=/([.?@])?(.*)/.exec(t);c.push({type:1,index:r,name:a[2],strings:n,ctor:"."===a[1]?H:"?"===a[1]?I:"@"===a[1]?L:k}),s.removeAttribute(e)}else e.startsWith(Ae)&&(c.push({type:6,index:r}),s.removeAttribute(e));if(Me.test(s.tagName)){const e=s.textContent.split(Ae),t=e.length-1;if(t>0){s.textContent=$e?$e.emptyScript:"";for(let n=0;n<t;n++)s.append(e[n],_e()),Ve.nextNode(),c.push({type:2,index:++r});s.append(e[t],_e())}}}else if(8===s.nodeType)if(s.data===Ie)c.push({type:2,index:r});else{let e=-1;for(;-1!==(e=s.data.indexOf(Ae,e+1));)c.push({type:7,index:r}),e+=Ae.length-1}r++}}static createElement(e,t){const n=ke.createElement("template");return n.innerHTML=e,n}}function Ke(e,t,n=e,s){if(t===je)return t;let r=void 0!==s?n._$Co?.[s]:n._$Cl;const o=De(t)?void 0:t._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),void 0===o?r=void 0:(r=new o(e),r._$AT(e,n,s)),void 0!==s?(n._$Co??=[])[s]=r:n._$Cl=r),void 0!==r&&(t=Ke(e,r._$AS(e,t.values),r,s)),t}class M{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:n}=this._$AD,s=(e?.creationScope??ke).importNode(t,!0);Ve.currentNode=s;let r=Ve.nextNode(),o=0,a=0,c=n[0];for(;void 0!==c;){if(o===c.index){let t;2===c.type?t=new R(r,r.nextSibling,this,e):1===c.type?t=new c.ctor(r,c.name,c.strings,this,e):6===c.type&&(t=new z(r,this,e)),this._$AV.push(t),c=n[++a]}o!==c?.index&&(r=Ve.nextNode(),o++)}return Ve.currentNode=ke,s}p(e){let t=0;for(const n of this._$AV)void 0!==n&&(void 0!==n.strings?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}}class R{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,s){this.type=2,this._$AH=He,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Ke(this,e,t),De(e)?e===He||null==e||""===e?(this._$AH!==He&&this._$AR(),this._$AH=He):e!==this._$AH&&e!==je&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>Ne(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==He&&De(this._$AH)?this._$AA.nextSibling.data=e:this.T(ke.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:n}=e,s="number"==typeof n?this._$AC(e):(void 0===n.el&&(n.el=N.createElement(Ge(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(t);else{const e=new M(s,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Fe.get(e.strings);return void 0===t&&Fe.set(e.strings,t=new N(e)),t}k(e){Ne(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let n,s=0;for(const r of e)s===t.length?t.push(n=new R(this.O(_e()),this.O(_e()),this,this.options)):n=t[s],n._$AI(r),s++;s<t.length&&(this._$AR(n&&n._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class k{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,s,r){this.type=1,this._$AH=He,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=r,n.length>2||""!==n[0]||""!==n[1]?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=He}_$AI(e,t=this,n,s){const r=this.strings;let o=!1;if(void 0===r)e=Ke(this,e,t,0),o=!De(e)||e!==this._$AH&&e!==je,o&&(this._$AH=e);else{const s=e;let a,c;for(e=r[0],a=0;a<r.length-1;a++)c=Ke(this,s[n+a],t,a),c===je&&(c=this._$AH[a]),o||=!De(c)||c!==this._$AH[a],c===He?e=He:e!==He&&(e+=(c??"")+r[a+1]),this._$AH[a]=c}o&&!s&&this.j(e)}j(e){e===He?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class H extends k{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===He?void 0:e}}class I extends k{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==He)}}class L extends k{constructor(e,t,n,s,r){super(e,t,n,s,r),this.type=5}_$AI(e,t=this){if((e=Ke(this,e,t,0)??He)===je)return;const n=this._$AH,s=e===He&&n!==He||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==He&&(n===He||s);s&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class z{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ke(this,e)}}const Je=xe.litHtmlPolyfillSupport;Je?.(N,R),(xe.litHtmlVersions??=[]).push("3.3.1");const We=globalThis;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class i extends Se{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,n)=>{const s=n?.renderBefore??t;let r=s._$litPart$;if(void 0===r){const e=n?.renderBefore??null;s._$litPart$=r=new R(t.insertBefore(_e(),e),e,void 0,n??{})}return r._$AI(e),r})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return je}}i._$litElement$=!0,i.finalized=!0,We.litElementHydrateSupport?.({LitElement:i});const Ze=We.litElementPolyfillSupport;Ze?.({LitElement:i}),(We.litElementVersions??=[]).push("4.2.1");
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   ...
   */function nt(e){return tt({...e,state:!0,attribute:!1})}const st=".wh_top_menu_and_indexterms_link",rt=".wh_publication_title .title",ot="",it="BrowserTest",at="qd-status-container",ct="qd-title-selector",dt="qd-instructor-hash",lt="qd-db-name";function ut(e,t){const n=document.querySelector(`#${e}`);if(!n)return t;const r=n.textContent?.trim()||"";return""===r?(o(`Config element #${e} found but empty, using default: "${t}"`),t):(s(`Config read from #${e}: "${r}"`),r)}var ht=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,gt=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?pt(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&ht(t,n,o),o};let mt=class extends i{constructor(){super(...arguments),this.title="Sonar Quiz System",this.name="",this.serviceId="",this.instructorPassword="",this.showInstructorModal=!1,this.modalOverlay=null,this.errorMessage="",this.instructorError="",this.isSubmitting=!1,this.handleLogoutEvent=()=>{this.name="",this.serviceId="",this.instructorPassword="",this.errorMessage="",this.instructorError="",this.isSubmitting=!1,this.showInstructorModal=!1,this.cleanupModal(),this.updateVisibility()},this.handleEscape=e=>{"Escape"===e.key&&this.showInstructorModal&&this.closeInstructorModal()}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),document.addEventListener("keydown",this.handleEscape),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleEscape),document.removeEventListener("qd:logout",this.handleLogoutEvent),this.cleanupModal()}cleanupModal(){this.modalOverlay&&(this.modalOverlay.remove(),this.modalOverlay=null)}firstUpdated(){this.setAttribute("data-ready","")}updateVisibility(){w(l.SESSION)?this.removeAttribute("data-show"):this.setAttribute("data-show","")}render(){return Be`
      <div class="login-container">
        ...
        <form class="login-form" @submit=${e=>this.handleStudentLogin(e)}>
          ...
          ${this.errorMessage?Be`<div class="error-message">${this.errorMessage}</div>`:""}
        </form>
      </div>
...
`;class RateLimiter{constructor(){this.failureCount=0,this.lockoutUntil=null}attempt(){return!(this.lockoutUntil&&Date.now()<this.lockoutUntil)&&(this.lockoutUntil&&Date.now()>=this.lockoutUntil&&(this.lockoutUntil=null),!0)}recordFailure(){this.failureCount++;const e=[2e3,4e3,8e3,16e3,3e4],t=e[Math.min(this.failureCount-1,e.length-1)]??3e4;this.lockoutUntil=Date.now()+t}reset(){this.failureCount=0,this.lockoutUntil=null}getRemainingSeconds(){if(!this.lockoutUntil)return 0;const e=Math.max(0,this.lockoutUntil-Date.now());return Math.ceil(e/1e3)}isLockedOut(){return null!==this.lockoutUntil&&Date.now()<this.lockoutUntil}}const St="instructor.password.hash";var xt=Object.defineProperty,$t=Object.getOwnPropertyDescriptor,Et=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?$t(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&xt(t,n,o),o};let Ct=class extends i{constructor(){super(...arguments),this.password="",this.error="",this.remainingSeconds=0,this.rateLimiter=new RateLimiter,this.handlePasswordInput=e=>{const t=e.target;this.password=t.value,this.error=""},this.handleSubmit=async e=>{e.preventDefault();if(!this.rateLimiter.attempt())return this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),this.startCountdown(),void(this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`);try{const e=function(){const e=document.getElementById(St);if(!e){const e=`Instructor password hash not found. Expected element with id="${St}". Check Oxygen XSL transform configuration.`;throw r(e),new Error(e)}const t=e.textContent?.trim();if(!t){const e="Instructor password hash element is empty. Check Oxygen parameter configuration.";throw r(e),new Error(e)}if(!/^[a-f0-9]{64}$/i.test(t)){const e=`Invalid password hash format. Expected 64 hex characters (SHA-256), got: ${t.substring(0,20)}...`;throw r(e),new Error(e)}return t.toLowerCase()}(),t=(new TextEncoder).encode(this.password),n=await crypto.subtle.digest("SHA-256",t),s=Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,"0")).join(""),o=await async function(e,t){if(e.length!==t.length)return!1;if(0===e.length)return!0;const n=new TextEncoder,s=n.encode(e),r=n.encode(t);try{const e=await crypto.subtle.importKey("raw",s,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),t=await crypto.subtle.sign("HMAC",e,r),n=await crypto.subtle.importKey("raw",r,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),o=await crypto.subtle.sign("HMAC",n,s);if(t.byteLength!==o.byteLength)return!1;const a=new Uint8Array(t),c=new Uint8Array(o);let d=0;for(let s=0;s<a.length;s++)d|=(a[s]??0)^(c[s]??0);return 0===d}catch(o){return console.error("Constant-time comparison failed:",o),!1}}(s,e);o?(this.rateLimiter.reset(),this.password="",this.error="",y(this,"qd:instructor-unlock",{})):(this.error="Invalid password",this.password="")}catch{this.error="Authentication failed",this.password=""}}}disconnectedCallback(){super.disconnectedCallback(),this.countdownInterval&&window.clearInterval(this.countdownInterval)}startCountdown(){this.countdownInterval&&window.clearInterval(this.countdownInterval),this.countdownInterval=window.setInterval(()=>{this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),0===this.remainingSeconds?(this.countdownInterval&&(window.clearInterval(this.countdownInterval),this.countdownInterval=void 0),this.error=""):this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`},1e3)}render(){const e=this.remainingSeconds>0;return Be`
      <div class="unlock-container">
        ...
        <form @submit=${this.handleSubmit}>
          ...
          ${this.error?Be`<div class="error">${this.error}</div>`:""}
    ...
    `}renderExpandedDetails(e){const t=Object.entries(e.pages);return 0===t.length?Be`
        <tr>
          ...
          <table style="margin: 0; width: 100%;">
            <thead>
              <tr>
                ...
                <th>Attempted</th>
                <th>Correct</th>
                <th>Percentage 888</th>
              </tr>
            </thead>
            <tbody>
              ${t.map(([e,t])=>{const n=t.answers||[],s=n.filter(e=>null!==e).length,r=n.filter(e=>!0===e?.success).length,o=s>0?Math.round(r/s*100):0;return Be`
                  <tr>
    ...
    `}render(){if(!this.showModal)return Be``;const e=[...this.students].sort((e,t)=>e.name.localeCompare(t.name));return Be`
      <div class="modal-overlay" @click=${this.handleClose}>
        <div class="modal-content" @click=${e=>e.stopPropagation()}>
          ...
          ${0===e.length?Be`<p>No student data available.</p>`:Be`
                <table>
                  <thead>
                    <tr>
                      <th>Name</th>
    ...
    `}};Tt.styles=wt,Nt([tt({type:Array})],Tt.prototype,"students",2),Tt=Nt([Xe("qd-instructor-export")],Tt);var Ot=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,zt=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?Pt(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&Ot(t,n,o),o};let Lt=class extends i{constructor(){super(...arguments),this.showConfirmDialog=!1,this.confirmText="",this.error="",this.success="",this.handleClearRequest=()=>{this.showConfirmDialog=!0,this.confirmText="",this.error="",this.success=""},this.handleCancelClear=()=>{this.showConfirmDialog=!1,this.confirmText="",this.error=""},this.handleConfirmInput=e=>{const t=e.target;this.confirmText=t.value},this.handleConfirmClear=()=>{if("DELETE ALL DATA"===this.confirmText)try{x(),y(this,"qd:data-cleared",{}),this.success="All quiz data cleared successfully",this.showConfirmDialog=!1,this.confirmText="",this.error="",setTimeout(()=>{this.success=""},3e3)}catch{this.error="Failed to clear data"}else this.error="Confirmation text does not match"}}render(){return Be`
      <button
      ...
      ${this.success?Be`
          ...
          `:""}
    `}renderConfirmDialog(){const e="DELETE ALL DATA"===this.confirmText;return Be`
    ...
    `],Mt([nt()],Bt.prototype,"unlocked",2),Mt([nt()],Bt.prototype,"showScores",2),Mt([nt()],Bt.prototype,"students",2),Mt([nt()],Bt.prototype,"showStudentAnswers",2),Bt=Mt([Xe("qd-instructor")],Bt);var jt=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,Ft=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?Ht(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&jt(t,n,o),o};let Vt=class extends i{constructor(){super(...arguments),this.dbName="quiz-scores",this.hidden=!0,this.visible=!1,this.indexedDBEntries=[],this.sessionStorageEntries=[],this.handleToggleEntry=e=>{e.expanded=!e.expanded,this.requestUpdate()},this.handleClearSessionStorage=()=>{confirm("Clear all sessionStorage?")&&(sessionStorage.clear(),this.refreshData())},this.handleClearIndexedDB=async()=>{if(confirm(`Clear IndexedDB "${this.dbName}"?`))try{const e=await this.openDatabase();for(const t of Array.from(e.objectStoreNames)){const n=e.transaction(t,"readwrite");n.objectStore(t).clear()}await this.refreshData()}catch(e){console.error("Failed to clear IndexedDB:",e)}},this.handleClose=()=>{this.visible=!1,this.hidden=!0}}connectedCallback(){super.connectedCallback(),this.setupKeyboardShortcut(),this.startRefresh()}disconnectedCallback(){super.disconnectedCallback(),this.stopRefresh()}setupKeyboardShortcut(){document.addEventListener("keydown",e=>{e.ctrlKey&&e.shiftKey&&"D"===e.key&&(e.preventDefault(),this.toggleVisibility())})}toggleVisibility(){this.visible=!this.visible,this.hidden=!this.visible}startRefresh(){this.refreshData(),this.refreshInterval=window.setInterval(()=>{this.refreshData()},1e3)}stopRefresh(){this.refreshInterval&&window.clearInterval(this.refreshInterval)}async refreshData(){await this.refreshIndexedDB(),this.refreshSessionStorage()}async refreshIndexedDB(){try{const e=await this.openDatabase(),t=[];for(const n of Array.from(e.objectStoreNames)){const s=e.transaction(n,"readonly"),r=s.objectStore(n).getAll();await new Promise((e,s)=>{r.onsuccess=()=>{r.result.forEach((e,s)=>{t.push({key:`${n}[${s}]`,value:e,expanded:!1})}),e()},r.onerror=()=>s(new Error(r.error?.message||"IndexedDB request failed"))})}this.indexedDBEntries=t}catch{this.indexedDBEntries=[]}}refreshSessionStorage(){const e=[];for(let t=0;t<sessionStorage.length;t++){const n=sessionStorage.key(t);if(n)try{const t=sessionStorage.getItem(n);e.push({key:n,value:t?JSON.parse(t):t,expanded:!1})}catch{e.push({key:n,value:sessionStorage.getItem(n),expanded:!1})}}this.sessionStorageEntries=e}openDatabase(){return new Promise((e,t)=>{const n=indexedDB.open(this.dbName);n.onsuccess=()=>e(n.result),n.onerror=()=>t(new Error(n.error?.message||"Failed to open database"))})}renderEntry(e){return Be`
      <div class="entry">
        <div class="entry-key" @click=${()=>this.handleToggleEntry(e)}>
          ${e.expanded?"▼":"▶"} ${e.key}
        </div>
        ${e.expanded?Be` <div class="entry-value">${JSON.stringify(e.value,null,2)}</div> `:""}
      </div>
    `}render(){return Be`
      <div class="header">
      ...
      <div class="content">
        <div class="section">
          ...
          ${0===this.indexedDBEntries.length?Be`<div class="empty">No entries</div>`:this.indexedDBEntries.map(e=>this.renderEntry(e))}
        </div>
        ...
        <div class="section">
          ...
          ${0===this.sessionStorageEntries.length?Be`<div class="empty">No entries</div>`:this.sessionStorageEntries.map(e=>this.renderEntry(e))}
        </div>
      </div>
    `}};Vt.styles=oe`
    :host {
