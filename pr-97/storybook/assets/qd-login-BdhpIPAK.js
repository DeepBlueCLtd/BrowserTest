import{i as x,a as y,x as p}from"./lit-element-DR9D0stx.js";import{n as k,t as M}from"./property-BRFVFa-w.js";import{r as l}from"./state-7B7Yt9om.js";import{S as C,h as H,g as $}from"./help-content-OC8L37iC.js";import{R as z,g as V,v as j,r as E,b as T}from"./instructor-auth-Dkd1BrSp.js";import{P as h,S as q,b as F}from"./storage-helpers-D_wcwu-v.js";import{g as K,n as X,h as Q,c as B,S as J}from"./migration-D_yK0_mn.js";import{w as Y,m as v,i as A}from"./logger-DdbYlyfi.js";import"./qd-password-modal-BO6kslGq.js";import"./qd-confirm-dialog-DChDrNIs.js";import"./qd-help-trigger-DqOyfU8-.js";import"./qd-help-popup-DyrM3QuK.js";import"./qd-migration-dialog-Ckz8R3ku.js";const Z=x`
    :host {
  ...
  `;L([k({type:Number})],m.prototype,"untilMs",2);L([l()],m.prototype,"seconds",2);m=L([M("qd-lockout-banner")],m);var lt=Object.defineProperty,dt=Object.getOwnPropertyDescriptor,d=(t,e,i,n)=>{for(var r=n>1?void 0:n?dt(e,i):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(r=(n?s(e,i,r):s(r))||r);return n&&r&&lt(e,i,r),r};let a=class extends y{constructor(){super(...arguments),this.title="Sonar Quiz System",this.name="",this.serviceId="",this.errorMessage="",this.isSubmitting=!1,this.pin="",this.lockoutUntil=0,this.showPinConfirmation=!1,this.helpOpen=!1,this.showMigrationDialog=!1,this.migrationError=null,this.pendingLoginData=null,this.authService=new nt,this.handleLoginEvent=()=>{this.updateVisibility()},this.handleLogoutEvent=()=>{this.name="",this.serviceId="",this.errorMessage="",this.isSubmitting=!1,this.pin="",this.lockoutUntil=0,this.showPinConfirmation=!1,this.helpOpen=!1,this.updateVisibility()},this.handleLockoutExpired=()=>{this.lockoutUntil=0},this.handleHelpOpen=()=>{this.helpOpen=!0},this.handleHelpClose=()=>{this.helpOpen=!1},this.handlePinConfirmationDismiss=()=>{this.showPinConfirmation=!1},this.handleMigrationComplete=()=>{if(this.showMigrationDialog=!1,this.migrationError=null,this.pendingLoginData){const{serviceId:t,name:e,release:i}=this.pendingLoginData;this.pendingLoginData=null,this.retryLoginAfterMigration(t,e,i)}},this.handleMigrationCancel=()=>{this.showMigrationDialog=!1,this.migrationError=null,this.pendingLoginData=null,this.errorMessage="Data migration cancelled. Please contact your instructor for assistance.",this.isSubmitting=!1}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),document.addEventListener("qd:logout",this.handleLogoutEvent),document.addEventListener("qd:login",this.handleLoginEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:logout",this.handleLogoutEvent),document.removeEventListener("qd:login",this.handleLoginEvent)}firstUpdated(){this.setAttribute("data-ready","")}updateVisibility(){this.toggleAttribute("data-show",!H())}isLockedOut(){return this.lockoutUntil>Date.now()}render(){return p`
      <div class="login-container">
        ...
        <form class="login-form" @submit=${t=>this.handleStudentLogin(t)}>
          ...
          ${this.errorMessage?p`<div class="error-message">${this.errorMessage}</div>`:this.validationHint?p`<div class="hint-message" role="status">${this.validationHint}</div>`:""}
          <qd-lockout-banner
