...
/**
  ...
  `,kt=((t,n,s,o)=>{for(var r,a=o>1?void 0:o?At(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=r(a)||a);return a})([ct("qd-build-info")],kt);var Tt=Object.defineProperty,_t=Object.getOwnPropertyDescriptor,Nt=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?_t(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Tt(n,s,a),a};let Pt=null;let Ot=class extends at{constructor(){super(...arguments),this.open=!1,this.closable=!0,this.previouslyFocused=null,this.portalElement=null,this.cloneMap=new Map,this.childObserver=null,this.handleKeyDown=t=>{"Escape"===t.key&&this.open&&this.closable&&(this.emitCloseEvent(),this.close())},this.handleBackdropClick=()=>{this.closable&&(this.emitCloseEvent(),this.close())},this.stopPropagation=t=>{t.stopPropagation()}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.handleKeyDown),this.ensureStyles(),this.childObserver=new MutationObserver(()=>{this.open&&this.portalElement&&this.createPortal()}),this.childObserver.observe(this,{childList:!0,subtree:!0,characterData:!0})}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleKeyDown),this.removePortal(),this.childObserver?.disconnect(),this.childObserver=null,Pt===this&&(Pt=null)}updated(t){t.has("open")&&(this.open?this.handleOpen():this.handleClose())}ensureStyles(){Ot.styleElement||(Ot.styleElement=document.createElement("style"),Ot.styleElement.textContent="\n  .qd-modal-backdrop {\n    position: fixed;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    background: rgba(0, 0, 0, 0.5);\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    z-index: 99999;\n    font-family: system-ui, -apple-system, sans-serif;\n    animation: qd-modal-fadeIn 0.15s ease-out;\n  }\n\n  @keyframes qd-modal-fadeIn {\n    from { opacity: 0; }\n    to { opacity: 1; }\n  }\n\n  .qd-modal-content {\n    background: white;\n    border-radius: 8px;\n    box-shadow: 0 4px 20px rgba(0, 0, 0, 0.3);\n    max-width: 90vw;\n    max-height: 90vh;\n    overflow: auto;\n    animation: qd-modal-slideIn 0.15s ease-out;\n  }\n\n  @keyframes qd-modal-slideIn {\n    from { transform: translateY(-20px); opacity: 0; }\n    to { transform: translateY(0); opacity: 1; }\n  }\n\n  .qd-modal-header {\n    padding: 16px 20px;\n    border-bottom: 1px solid #eee;\n    font-weight: 600;\n    font-size: 18px;\n  }\n\n  .qd-modal-header:empty {\n    display: none;\n  }\n\n  .qd-modal-body {\n    padding: 20px;\n  }\n",document.head.appendChild(Ot.styleElement))}createPortal(){this.removePortal(),this.cloneMap.clear(),this.portalElement=document.createElement("div"),this.portalElement.className="qd-modal-backdrop",this.portalElement.addEventListener("click",this.handleBackdropClick);const t=document.createElement("div");t.className="qd-modal-content",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.addEventListener("click",this.stopPropagation);const n=document.createElement("div");n.className="qd-modal-header";const s=document.createElement("div");s.className="qd-modal-body";const o=this.querySelector('[slot="header"]');o&&n.appendChild(o.cloneNode(!0)),Array.from(this.children).forEach(t=>{if(!t.hasAttribute("slot")||"header"!==t.getAttribute("slot")){const n=t.cloneNode(!0);this.cloneMap.set(t,n),s.appendChild(n)}}),t.appendChild(n),t.appendChild(s),this.portalElement.appendChild(t),document.body.appendChild(this.portalElement),this.setupFormEventForwarding(s)}setupFormEventForwarding(t){t.querySelectorAll("form").forEach(t=>{t.addEventListener("submit",n=>{n.preventDefault();const s=new FormData(t),o={};s.forEach((t,n)=>{o[n]=t.toString()});const r=t.querySelector('input[type="password"]');r&&(o.password=r.value);const a=new CustomEvent("qd:password-submit",{detail:o,bubbles:!0,composed:!0});this.dispatchEvent(a)})})}removePortal(){this.portalElement&&(this.portalElement.remove(),this.portalElement=null)}render(){return Ze}show(){this.open=!0}close(){this.open=!1}refreshPortal(){this.open&&this.portalElement&&this.createPortal()}handleOpen(){Pt&&Pt!==this&&Pt.close(),Pt=this,this.previouslyFocused=document.activeElement,this.createPortal(),requestAnimationFrame(()=>{this.focusFirstElement()})}handleClose(){Pt===this&&(Pt=null),this.removePortal(),this.previouslyFocused instanceof HTMLElement&&this.previouslyFocused.focus()}focusFirstElement(){if(!this.portalElement)return;const t=this.portalElement.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');t&&t.focus()}emitCloseEvent(){const t=new CustomEvent("qd:modal-close",{bubbles:!0,composed:!0});this.dispatchEvent(t)}};Ot.styleElement=null,Nt([ht({type:Boolean,reflect:!0})],Ot.prototype,"open",2),Nt([ht({type:Boolean})],Ot.prototype,"closable",2),Ot=Nt([ct("qd-modal")],Ot);var Lt=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,zt=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Dt(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Lt(n,s,a),a};let Rt=class extends at{constructor(){super(...arguments),this.open=!1,this.title="Enter Password",this.error="",this.password="",this.handleModalClose=()=>{this.close()},this.handleInput=t=>{const n=t.target;this.password=n.value,this.error&&(this.error="")},this.handleSubmit=t=>{t.preventDefault(),this.password.trim()&&this.dispatchEvent(new CustomEvent("qd:password-submit",{detail:{password:this.password},bubbles:!0,composed:!0}))},this.handleForwardedSubmit=t=>{t.stopPropagation();const n=t.detail?.password||"";n.trim()&&this.dispatchEvent(new CustomEvent("qd:password-submit",{detail:{password:n},bubbles:!0,composed:!0}))},this.handleCancel=()=>{this.close()}}show(){this.open=!0,this.password="",this.error=""}close(){this.open=!1,this.password="",this.error="",this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}syncErrorToPortal(){const t=document.querySelector(".qd-modal-backdrop");if(!t)return;const n=t.querySelector("form.password-form");if(!n)return;let s=n.querySelector(".error-message");if(this.error){if(!s){s=document.createElement("div"),s.className="error-message";const t=n.querySelector(".button-row");t?n.insertBefore(s,t):n.appendChild(s)}s.textContent=this.error}else s?.remove()}updated(t){t.has("open")&&this.open&&(this.password="",this.updateComplete.then(()=>{this.passwordInput?.focus()})),t.has("error")&&this.open&&this.updateComplete.then(()=>{setTimeout(()=>{this.syncErrorToPortal()},0)})}render(){return this.open?Ye`
      <qd-modal
        .open=${this.open}
...
var Mt;Rt.styles=me`
  ...
  `,zt([ht({type:Boolean,reflect:!0})],Rt.prototype,"open",2),zt([ht({type:String})],Rt.prototype,"title",2),zt([ht({type:String})],Rt.prototype,"error",2),zt([pt()],Rt.prototype,"password",2),zt([(Mt='input[type="password"]',(t,n,s)=>((t,n,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&"object"!=typeof n&&Object.defineProperty(t,n,s),s))(t,n,{get(){return(t=>t.renderRoot?.querySelector(Mt)??null)(this)}}))],Rt.prototype,"passwordInput",2),Rt=zt([ct("qd-password-modal")],Rt);var Ut=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,jt=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Ht(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Ut(n,s,a),a};let Bt=class extends at{constructor(){super(...arguments),this.title="Sonar Quiz System",this.name="",this.serviceId="",this.showInstructorModal=!1,this.instructorError="",this.errorMessage="",this.isSubmitting=!1,this.pin="",this.lockoutSeconds=0,this.lockoutInterval=null,this.handleLogoutEvent=()=>{this.name="",this.serviceId="",this.errorMessage="",this.isSubmitting=!1,this.showInstructorModal=!1,this.instructorError="",this.pin="",this.lockoutSeconds=0,this.lockoutInterval&&(clearInterval(this.lockoutInterval),this.lockoutInterval=null),this.updateVisibility()},this.handleInstructorPasswordSubmit=t=>{this.handleInstructorLogin(t.detail.password)},this.handleInstructorModalClose=()=>{this.showInstructorModal=!1,this.instructorError=""}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:logout",this.handleLogoutEvent),this.lockoutInterval&&(clearInterval(this.lockoutInterval),this.lockoutInterval=null)}firstUpdated(){this.setAttribute("data-ready","")}updateVisibility(){$(u.SESSION)?this.removeAttribute("data-show"):this.setAttribute("data-show","")}render(){return Ye`
  ...
  `,Qt([pt()],Kt.prototype,"total",2),Qt([pt()],Kt.prototype,"correct",2),Qt([pt()],Kt.prototype,"percentage",2),Qt([pt()],Kt.prototype,"statusColor",2),Qt([pt()],Kt.prototype,"name",2),Qt([pt()],Kt.prototype,"serviceId",2),Kt=Qt([ct("qd-status")],Kt);const Wt=me`
  :host {
    display: inline-block;
    font-family:
      system-ui,
...
`;class RateLimiter{constructor(){this.failureCount=0,this.lockoutUntil=null}attempt(){return!(this.lockoutUntil&&Date.now()<this.lockoutUntil)&&(this.lockoutUntil&&Date.now()>=this.lockoutUntil&&(this.lockoutUntil=null),!0)}recordFailure(){this.failureCount++;const t=[2e3,4e3,8e3,16e3,3e4],n=t[Math.min(this.failureCount-1,t.length-1)]??3e4;this.lockoutUntil=Date.now()+n}reset(){this.failureCount=0,this.lockoutUntil=null}getRemainingSeconds(){if(!this.lockoutUntil)return 0;const t=Math.max(0,this.lockoutUntil-Date.now());return Math.ceil(t/1e3)}isLockedOut(){return null!==this.lockoutUntil&&Date.now()<this.lockoutUntil}}const Jt="instructor.password.hash";var Yt=Object.defineProperty,Gt=Object.getOwnPropertyDescriptor,Zt=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Gt(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Yt(n,s,a),a};let Xt=class extends at{constructor(){super(...arguments),this.password="",this.error="",this.remainingSeconds=0,this.rateLimiter=new RateLimiter,this.handlePasswordInput=t=>{const n=t.target;this.password=n.value,this.error=""},this.handleSubmit=async t=>{t.preventDefault();if(!this.rateLimiter.attempt())return this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),this.startCountdown(),void(this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`);try{const t=function(){const t=document.getElementById(Jt);if(!t){const t=`Instructor password hash not found. Expected element with id="${Jt}". Check Oxygen XSL transform configuration.`;throw r(t),new Error(t)}const n=t.textContent?.trim();if(!n){const t="Instructor password hash element is empty. Check Oxygen parameter configuration.";throw r(t),new Error(t)}if(!/^[a-f0-9]{64}$/i.test(n)){const t=`Invalid password hash format. Expected 64 hex characters (SHA-256), got: ${n.substring(0,20)}...`;throw r(t),new Error(t)}return n.toLowerCase()}(),n=(new TextEncoder).encode(this.password),s=await crypto.subtle.digest("SHA-256",n),o=Array.from(new Uint8Array(s)).map(t=>t.toString(16).padStart(2,"0")).join(""),a=await async function(t,n){if(t.length!==n.length)return!1;if(0===t.length)return!0;const s=new TextEncoder,o=s.encode(t),r=s.encode(n);try{const t=await crypto.subtle.importKey("raw",o,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),n=await crypto.subtle.sign("HMAC",t,r),s=await crypto.subtle.importKey("raw",r,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),a=await crypto.subtle.sign("HMAC",s,o);if(n.byteLength!==a.byteLength)return!1;const d=new Uint8Array(n),c=new Uint8Array(a);let l=0;for(let o=0;o<d.length;o++)l|=(d[o]??0)^(c[o]??0);return 0===l}catch(a){return console.error("Constant-time comparison failed:",a),!1}}(o,t);a?(this.rateLimiter.reset(),this.password="",this.error="",E(this,"qd:instructor-unlock",{})):(this.error="Invalid password",this.password="")}catch{this.error="Authentication failed",this.password=""}}}disconnectedCallback(){super.disconnectedCallback(),this.countdownInterval&&window.clearInterval(this.countdownInterval)}startCountdown(){this.countdownInterval&&window.clearInterval(this.countdownInterval),this.countdownInterval=window.setInterval(()=>{this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),0===this.remainingSeconds?(this.countdownInterval&&(window.clearInterval(this.countdownInterval),this.countdownInterval=void 0),this.error=""):this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`},1e3)}render(){const t=this.remainingSeconds>0;return Ye`
    ...
    `}};Xt.styles=Wt,Zt([pt()],Xt.prototype,"password",2),Zt([pt()],Xt.prototype,"error",2),Zt([pt()],Xt.prototype,"remainingSeconds",2),Xt=Zt([ct("qd-instructor-unlock")],Xt);var en=Object.defineProperty,tn=Object.getOwnPropertyDescriptor,nn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?tn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&en(n,s,a),a};let sn=class extends at{constructor(){super(...arguments),this.open=!1,this.students=[],this.expandedStudents=new Set,this.handleModalClose=()=>{this.open=!1,this.dispatchEvent(new CustomEvent("close"))}}updated(t){t.has("open")&&this.open&&(this.expandedStudents=new Set(this.students.map(t=>t.serviceId)))}render(){return Ye`
  ...
  `,nn([ht({type:Boolean,reflect:!0})],sn.prototype,"open",2),nn([ht({type:Array})],sn.prototype,"students",2),nn([pt()],sn.prototype,"expandedStudents",2),sn=nn([ct("qd-scores-modal")],sn);var on=Object.defineProperty,rn=Object.getOwnPropertyDescriptor,an=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?rn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&on(n,s,a),a};let dn=class extends at{constructor(){super(...arguments),this.students=[],this.showModal=!1,this.handleClose=()=>{this.dispatchEvent(new CustomEvent("close"))}}render(){return Ye`
    ...
    `}};fn.styles=Wt,gn([pt()],fn.prototype,"showConfirmDialog",2),gn([pt()],fn.prototype,"confirmText",2),gn([pt()],fn.prototype,"error",2),gn([pt()],fn.prototype,"success",2),fn=gn([ct("qd-instructor-manage")],fn);
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class e extends i{constructor(t){if(super(t),this.it=Ze,t.type!==bn)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Ze||null==t)return this._t=void 0,this.it=t;if(t===Ge)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}e.directiveName="unsafeHTML",e.resultType=1;const vn=(t=>(...n)=>({_$litDirective$:t,values:n}))(e);var yn=Object.defineProperty,wn=Object.getOwnPropertyDescriptor,Sn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?wn(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&yn(n,s,a),a};let xn=class extends at{constructor(){super(...arguments),this.open=!1,this.title="Confirm",this.message="",this.confirmText="Confirm",this.cancelText="Cancel",this.destructive=!1,this.handleModalClose=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:cancel",{bubbles:!0,composed:!0}))},this.handleConfirm=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:confirm",{bubbles:!0,composed:!0}))},this.handleCancel=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:cancel",{bubbles:!0,composed:!0}))}}show(){this.open=!0}close(){this.open=!1}render(){return Ye`
      <qd-modal .open=${this.open} @qd:modal-close=${this.handleModalClose}>
        <span slot="header">${this.title}</span>
  ...
  `,Sn([ht({type:Boolean,reflect:!0})],xn.prototype,"open",2),Sn([ht({type:String})],xn.prototype,"title",2),Sn([ht({type:String})],xn.prototype,"message",2),Sn([ht({type:String})],xn.prototype,"confirmText",2),Sn([ht({type:String})],xn.prototype,"cancelText",2),Sn([ht({type:Boolean})],xn.prototype,"destructive",2),xn=Sn([ct("qd-confirm-dialog")],xn);var En=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,Cn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?$n(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&En(n,s,a),a};let In=class extends at{constructor(){super(...arguments),this.students=[],this.showModal=!1,this.searchText="",this.confirmingStudent=null,this.confirmDialogOpen=!1,this.modalElement=null,this.handleEscape=t=>{if("Escape"===t.key&&this.showModal){if(this.confirmDialogOpen)return;this.handleClose()}},this.handleClose=()=>{this.confirmingStudent=null,this.confirmDialogOpen=!1,this.searchText="",this.dispatchEvent(new CustomEvent("close"))},this.handleConfirmReset=()=>{this.confirmingStudent&&this.executeReset(this.confirmingStudent)},this.handleCancelReset=()=>{this.confirmDialogOpen=!1,this.confirmingStudent=null}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.handleEscape)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleEscape),this.removeModalFromBody()}updated(t){t.has("showModal")&&(this.showModal?this.renderModalToBody():this.removeModalFromBody())}get filteredStudents(){if(!this.searchText.trim())return this.students;const t=this.searchText.toLowerCase().trim();return this.students.filter(n=>n.name.toLowerCase().includes(t)||n.serviceId.toLowerCase().includes(t))}renderModalToBody(){this.removeModalFromBody();const t=document.createElement("div");t.className="qd-pin-reset-overlay",t.style.cssText="\n      position: fixed;\n      top: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      background: rgba(0, 0, 0, 0.5);\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      z-index: 99999;\n      font-family: system-ui, -apple-system, sans-serif;\n    ";const n=document.createElement("div");n.style.cssText="\n      background: white;\n      border-radius: 8px;\n      padding: 24px;\n      min-width: 400px;\n      max-width: 500px;\n      max-height: 80vh;\n      overflow: hidden;\n      display: flex;\n      flex-direction: column;\n      box-shadow: 0 4px 16px rgba(0, 0, 0, 0.2);\n    ";const s=document.createElement("div");s.style.cssText="\n      display: flex;\n      justify-content: space-between;\n      align-items: center;\n      margin-bottom: 16px;\n    ";const o=document.createElement("h3");o.textContent="Reset Student PIN",o.style.cssText="font-size: 18px; font-weight: 600; margin: 0;";const r=document.createElement("button");r.textContent="×",r.type="button",r.style.cssText="\n      background: none;\n      border: none;\n      font-size: 24px;\n      cursor: pointer;\n      color: #666;\n    ",r.onclick=()=>this.handleClose(),s.appendChild(o),s.appendChild(r);const a=document.createElement("input");a.type="text",a.placeholder="Search by name or ID...",a.style.cssText="\n      width: 100%;\n      box-sizing: border-box;\n      padding: 8px 12px;\n      border: 1px solid #ccc;\n      border-radius: 4px;\n      margin-bottom: 12px;\n      font-size: 12px;\n    ",a.oninput=t=>{this.searchText=t.target.value,this.updateStudentList(n)};const d=document.createElement("div");d.className="student-list",d.style.cssText="\n      flex: 1;\n      overflow-y: auto;\n      max-height: 300px;\n      border: 1px solid #e0e0e0;\n      border-radius: 4px;\n    ",n.appendChild(s),n.appendChild(a),n.appendChild(d);const c=document.createElement("div");c.className="error-message",c.style.cssText="\n      display: none;\n      color: #d32f2f;\n      font-size: 11px;\n      margin-top: 8px;\n      padding: 8px;\n      background: #ffebee;\n      border-radius: 4px;\n    ",n.appendChild(c),t.appendChild(n),t.onclick=n=>{n.target===t&&this.handleClose()},document.body.appendChild(t),this.modalElement=t,this.updateStudentList(n),a.focus()}updateStudentList(t){const n=t.querySelector(".student-list");if(!n)return;n.innerHTML="";const s=this.filteredStudents;if(0===s.length){const t=document.createElement("div");return t.textContent=this.searchText?"No matching students":"No students found",t.style.cssText="padding: 16px; text-align: center; color: #666; font-size: 12px;",void n.appendChild(t)}s.forEach(s=>{const o=document.createElement("div");o.style.cssText="\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        padding: 8px 12px;\n        border-bottom: 1px solid #f0f0f0;\n      ";const r=document.createElement("div"),a=document.createElement("div");a.textContent=s.name,a.style.cssText="font-size: 12px; font-weight: 500;";const d=document.createElement("div");d.textContent=`ID: ${s.serviceId}`,d.style.cssText="font-size: 10px; color: #666;";const c=document.createElement("div"),l=s.pinHash&&s.pinHash.length>0;c.textContent=l?"PIN set":"No PIN",c.style.cssText=`font-size: 10px; color: ${l?"#4caf50":"#ff9800"};`,r.appendChild(a),r.appendChild(d),r.appendChild(c);const u=document.createElement("button");u.textContent="Reset PIN",u.type="button",u.style.cssText="\n        background: #ff5722;\n        color: white;\n        border: none;\n        border-radius: 4px;\n        padding: 4px 8px;\n        font-size: 10px;\n        cursor: pointer;\n      ",u.onclick=()=>this.showConfirmation(s,t),o.appendChild(r),o.appendChild(u),n.appendChild(o)})}showConfirmation(t,n){this.confirmingStudent=t,this.confirmDialogOpen=!0}async executeReset(t){try{const s=document.getElementById(wt);if(!s?.textContent?.trim())throw new Error(`Database name not configured. Add <span id="${wt}">dbName</span> to page.`);const o=U(s.textContent.trim());await o.init();const r=(n=t,{...n,pinHash:"",pinResetAt:(new Date).toISOString()});await o.saveStudent(r);const a={eventId:crypto.randomUUID(),serviceId:t.serviceId,resetBy:"instructor",resetAt:(new Date).toISOString(),release:t.release};await o.saveAuditEvent(a);const d=this.students.findIndex(n=>n.serviceId===t.serviceId);if(d>=0&&(this.students[d]=r,this.students=[...this.students]),this.dispatchEvent(new CustomEvent("qd:pin-reset",{detail:{serviceId:t.serviceId,resetBy:"instructor",timestamp:(new Date).toISOString()},bubbles:!0,composed:!0})),this.confirmDialogOpen=!1,this.confirmingStudent=null,this.modalElement){const t=this.modalElement.querySelector("div");t&&this.updateStudentList(t)}}catch(s){if(console.error("PIN reset error:",s),this.modalElement){const t=this.modalElement.querySelector("div"),n=t?.querySelector(".error-message");n&&(n.textContent="Failed to reset PIN. Please try again.",n.style.display="block")}this.confirmDialogOpen=!1,this.confirmingStudent=null}var n}removeModalFromBody(){this.modalElement&&(this.modalElement.remove(),this.modalElement=null)}render(){const t=this.confirmingStudent,n=t?`Reset PIN for <strong>${t.name}</strong> (${t.serviceId})?<br><span style="font-size: 11px; color: #666;">They will need to create a new PIN on next login.</span>`:"";return Ye`
      <qd-confirm-dialog
