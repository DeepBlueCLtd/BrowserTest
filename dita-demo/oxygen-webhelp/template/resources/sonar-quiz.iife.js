...
/**
  ...
  `,Bt([ht({type:Boolean,reflect:!0})],Vt.prototype,"open",2),Bt([ht({type:String})],Vt.prototype,"title",2),Bt([ht({type:String})],Vt.prototype,"message",2),Bt([ht({type:String})],Vt.prototype,"confirmText",2),Bt([ht({type:String})],Vt.prototype,"cancelText",2),Bt([ht({type:Boolean})],Vt.prototype,"destructive",2),Vt=Bt([dt("qd-confirm-dialog")],Vt);var Qt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,Wt=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Kt(n,s):n,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Qt(n,s,a),a};let Jt=class extends at{constructor(){super(...arguments),this.panelType="login",this.handleClick=()=>{this.dispatchEvent(new CustomEvent("qd:help-open",{detail:{panelType:this.panelType},bubbles:!0,composed:!0}))}}render(){return Ye`
      <button
        class="help-icon"
  ...
  `,on([ht({type:String})],rn.prototype,"title",2),on([pt()],rn.prototype,"name",2),on([pt()],rn.prototype,"serviceId",2),on([pt()],rn.prototype,"showInstructorModal",2),on([pt()],rn.prototype,"instructorError",2),on([pt()],rn.prototype,"errorMessage",2),on([pt()],rn.prototype,"isSubmitting",2),on([pt()],rn.prototype,"pin",2),on([pt()],rn.prototype,"lockoutSeconds",2),on([pt()],rn.prototype,"showPinConfirmation",2),on([pt()],rn.prototype,"helpOpen",2),rn=on([dt("qd-login")],rn);var an=Object.defineProperty,cn=Object.getOwnPropertyDescriptor,dn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?cn(n,s):n,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&an(n,s,a),a};let ln=class extends at{constructor(){super(...arguments),this.total=0,this.correct=0,this.percentage=0,this.statusColor="red",this.name="",this.serviceId="",this.helpOpen=!1,this.handleStateChanged=()=>{this.loadCache()},this.handleLogin=()=>{this.updateVisibility(),this.loadCache()},this.handleLogoutEvent=()=>{this.updateVisibility()},this.handleHelpOpen=()=>{this.helpOpen=!0},this.handleHelpClose=()=>{this.helpOpen=!1}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),this.loadCache(),document.addEventListener("qd:state-changed",this.handleStateChanged),document.addEventListener("qd:login",this.handleLogin),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:state-changed",this.handleStateChanged),document.removeEventListener("qd:login",this.handleLogin),document.removeEventListener("qd:logout",this.handleLogoutEvent)}render(){const t=this.serviceId.slice(-4);return Ye`
  ...
  `,dn([pt()],ln.prototype,"total",2),dn([pt()],ln.prototype,"correct",2),dn([pt()],ln.prototype,"percentage",2),dn([pt()],ln.prototype,"statusColor",2),dn([pt()],ln.prototype,"name",2),dn([pt()],ln.prototype,"serviceId",2),dn([pt()],ln.prototype,"helpOpen",2),ln=dn([dt("qd-status")],ln);const un=me`
  :host {
    display: inline-block;
    font-family:
      system-ui,
...
`;class RateLimiter{constructor(){this.failureCount=0,this.lockoutUntil=null}attempt(){return!(this.lockoutUntil&&Date.now()<this.lockoutUntil)&&(this.lockoutUntil&&Date.now()>=this.lockoutUntil&&(this.lockoutUntil=null),!0)}recordFailure(){this.failureCount++;const t=[2e3,4e3,8e3,16e3,3e4],n=t[Math.min(this.failureCount-1,t.length-1)]??3e4;this.lockoutUntil=Date.now()+n}reset(){this.failureCount=0,this.lockoutUntil=null}getRemainingSeconds(){if(!this.lockoutUntil)return 0;const t=Math.max(0,this.lockoutUntil-Date.now());return Math.ceil(t/1e3)}isLockedOut(){return null!==this.lockoutUntil&&Date.now()<this.lockoutUntil}}const hn="instructor.password.hash";var pn=Object.defineProperty,mn=Object.getOwnPropertyDescriptor,gn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?mn(n,s):n,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&pn(n,s,a),a};let fn=class extends at{constructor(){super(...arguments),this.password="",this.error="",this.remainingSeconds=0,this.rateLimiter=new RateLimiter,this.handlePasswordInput=t=>{const n=t.target;this.password=n.value,this.error=""},this.handleSubmit=async t=>{t.preventDefault();if(!this.rateLimiter.attempt())return this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),this.startCountdown(),void(this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`);try{const t=function(){const t=document.getElementById(hn);if(!t){const t=`Instructor password hash not found. Expected element with id="${hn}". Check Oxygen XSL transform configuration.`;throw r(t),new Error(t)}const n=t.textContent?.trim();if(!n){const t="Instructor password hash element is empty. Check Oxygen parameter configuration.";throw r(t),new Error(t)}if(!/^[a-f0-9]{64}$/i.test(n)){const t=`Invalid password hash format. Expected 64 hex characters (SHA-256), got: ${n.substring(0,20)}...`;throw r(t),new Error(t)}return n.toLowerCase()}(),n=(new TextEncoder).encode(this.password),s=await crypto.subtle.digest("SHA-256",n),o=Array.from(new Uint8Array(s)).map(t=>t.toString(16).padStart(2,"0")).join(""),a=await async function(t,n){if(t.length!==n.length)return!1;if(0===t.length)return!0;const s=new TextEncoder,o=s.encode(t),r=s.encode(n);try{const t=await crypto.subtle.importKey("raw",o,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),n=await crypto.subtle.sign("HMAC",t,r),s=await crypto.subtle.importKey("raw",r,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),a=await crypto.subtle.sign("HMAC",s,o);if(n.byteLength!==a.byteLength)return!1;const c=new Uint8Array(n),d=new Uint8Array(a);let l=0;for(let o=0;o<c.length;o++)l|=(c[o]??0)^(d[o]??0);return 0===l}catch(a){return console.error("Constant-time comparison failed:",a),!1}}(o,t);a?(this.rateLimiter.reset(),this.password="",this.error="",E(this,"qd:instructor-unlock",{})):(this.error="Invalid password",this.password="")}catch{this.error="Authentication failed",this.password=""}}}disconnectedCallback(){super.disconnectedCallback(),this.countdownInterval&&window.clearInterval(this.countdownInterval)}startCountdown(){this.countdownInterval&&window.clearInterval(this.countdownInterval),this.countdownInterval=window.setInterval(()=>{this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),0===this.remainingSeconds?(this.countdownInterval&&(window.clearInterval(this.countdownInterval),this.countdownInterval=void 0),this.error=""):this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`},1e3)}render(){const t=this.remainingSeconds>0;return Ye`
  ...
  `,Ln([ht({type:Array})],Dn.prototype,"students",2),Ln([ht({type:Boolean,reflect:!0})],Dn.prototype,"open",2),Ln([pt()],Dn.prototype,"searchText",2),Ln([pt()],Dn.prototype,"confirmingStudent",2),Ln([pt()],Dn.prototype,"confirmDialogOpen",2),Ln([pt()],Dn.prototype,"errorMessage",2),Ln([ht({type:Boolean})],Dn.prototype,"showModal",1),Dn=Ln([dt("qd-pin-reset-dialog")],Dn);var zn=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,Mn=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Rn(n,s):n,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&zn(n,s,a),a};let Hn=class extends at{constructor(){super(...arguments),this.unlocked=!1,this.showScores=!1,this.students=[],this.showStudentAnswers=!1,this.showPinReset=!1,this.helpOpen=!1,this.handleLoginEvent=t=>{const n=t,s=n.detail?.role;this.updateVisibility(),"instructor"===s&&this.unlock()},this.handleLogoutEvent=()=>{this.updateVisibility(),this.lock()},this.handleResetPins=async()=>{const t=C(u.SESSION);if(t){try{const{getStorageService:n}=await Promise.resolve().then(()=>Q),s=n(),o=await s.getStudentsByRelease(t.release);this.students=o}catch(n){console.error("Failed to load students:",n),this.students=[]}this.showPinReset=!0}},this.handleClosePinReset=()=>{this.showPinReset=!1},this.handlePinReset=()=>{this.dispatchEvent(new CustomEvent("qd:pin-reset",{bubbles:!0,composed:!0}))},this.handleUnlock=()=>{this.unlocked=!0,this.dispatchEvent(new CustomEvent("qd:instructor-unlock",{bubbles:!0,composed:!0}))},this.handleViewScores=async()=>{const t=C(u.SESSION);if(t){try{const{getStorageService:n}=await Promise.resolve().then(()=>Q),s=n(),o=await s.getStudentsByRelease(t.release);this.students=o}catch(n){console.error("Failed to load students:",n),this.students=[]}this.showScores=!0}},this.handleCloseScores=()=>{this.showScores=!1},this.handleDataCleared=()=>{this.dispatchEvent(new CustomEvent("qd:data-cleared",{bubbles:!0,composed:!0})),this.students=[]},this.handleLogout=()=>{const t=C(u.SESSION);(new SessionService).clearSession(),this.dispatchEvent(new CustomEvent("qd:logout",{detail:{serviceId:t?.serviceId||"unknown"},bubbles:!0,composed:!0}))},this.handleToggleStudentAnswers=async t=>{const n=t.target;if(this.showStudentAnswers=n.checked,this.showStudentAnswers&&0===this.students.length){const t=C(u.SESSION);if(t)try{const{getStorageService:n}=await Promise.resolve().then(()=>Q),s=n(),o=await s.getStudentsByRelease(t.release);this.students=o}catch(o){console.error("Failed to load students for toggle:",o)}}const s=this.showStudentAnswers?"qd:instructor-show-answers":"qd:instructor-hide-answers";this.dispatchEvent(new CustomEvent(s,{bubbles:!0,composed:!0})),sessionStorage.setItem("qd/instructor/showAnswers",String(this.showStudentAnswers))},this.handleHelpOpen=()=>{this.helpOpen=!0},this.handleHelpClose=()=>{this.helpOpen=!1}}connectedCallback(){super.connectedCallback(),this.updateVisibility();const t="true"===sessionStorage.getItem(u.INSTRUCTOR);t&&this.unlock();const n=sessionStorage.getItem("qd/instructor/showAnswers");null!==n&&(this.showStudentAnswers="true"===n,this.showStudentAnswers&&t&&setTimeout(()=>{this.dispatchEvent(new CustomEvent("qd:instructor-show-answers",{bubbles:!0,composed:!0}))},100)),document.addEventListener("qd:login",this.handleLoginEvent),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:login",this.handleLoginEvent),document.removeEventListener("qd:logout",this.handleLogoutEvent)}updateVisibility(){"true"===sessionStorage.getItem(u.INSTRUCTOR)?this.setAttribute("data-show",""):this.removeAttribute("data-show")}setStudents(t){this.students=t}unlock(){this.unlocked=!0}lock(){this.unlocked=!1,this.showScores=!1,this.showPinReset=!1}render(){return this.unlocked?Ye`
      <div class="instructor-panel">
        ...
        <qd-help-popup
          .open=${this.helpOpen}
          .title=${tn("instructor").title}
          .content=${tn("instructor").body}
          @qd:modal-close=${this.handleHelpClose}
        ></qd-help-popup>
      </div>
    `:Ye`
