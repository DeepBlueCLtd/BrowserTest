...
/**
  ...
  `,Xe([he()],ts.prototype,"total",2),Xe([he()],ts.prototype,"correct",2),Xe([he()],ts.prototype,"percentage",2),Xe([he()],ts.prototype,"statusColor",2),Xe([he()],ts.prototype,"name",2),Xe([he()],ts.prototype,"serviceId",2),ts=Xe([ce("qd-status")],ts);const es=pt`
  :host {
    display: inline-block;
    font-family:
      system-ui,
