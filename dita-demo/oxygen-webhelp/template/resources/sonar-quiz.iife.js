...
/**
  ...
  `,bt([rt({type:String})],vt.prototype,"title",2),bt([ot()],vt.prototype,"name",2),bt([ot()],vt.prototype,"serviceId",2),bt([ot()],vt.prototype,"instructorPassword",2),bt([ot()],vt.prototype,"showInstructorModal",2),bt([ot()],vt.prototype,"errorMessage",2),bt([ot()],vt.prototype,"instructorError",2),bt([ot()],vt.prototype,"isSubmitting",2),vt=bt([tt("qd-login")],vt);var yt=Object.defineProperty,wt=Object.getOwnPropertyDescriptor,St=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?wt(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&yt(t,n,o),o};let xt=class extends i{constructor(){super(...arguments),this.total=0,this.correct=0,this.percentage=0,this.statusColor="red",this.handleStateChanged=()=>{this.loadCache()},this.handleLogin=()=>{this.updateVisibility(),this.loadCache()},this.handleLogoutEvent=()=>{this.updateVisibility()}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),this.loadCache(),document.addEventListener("qd:state-changed",this.handleStateChanged),document.addEventListener("qd:login",this.handleLogin),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:state-changed",this.handleStateChanged),document.removeEventListener("qd:login",this.handleLogin),document.removeEventListener("qd:logout",this.handleLogoutEvent)}render(){return Fe`
  ...
  `,St([ot()],xt.prototype,"total",2),St([ot()],xt.prototype,"correct",2),St([ot()],xt.prototype,"percentage",2),St([ot()],xt.prototype,"statusColor",2),xt=St([tt("qd-status")],xt);const Et=ce`
  :host {
...
`;class RateLimiter{constructor(){this.failureCount=0,this.lockoutUntil=null}attempt(){return!(this.lockoutUntil&&Date.now()<this.lockoutUntil)&&(this.lockoutUntil&&Date.now()>=this.lockoutUntil&&(this.lockoutUntil=null),!0)}recordFailure(){this.failureCount++;const e=[2e3,4e3,8e3,16e3,3e4],t=e[Math.min(this.failureCount-1,e.length-1)]??3e4;this.lockoutUntil=Date.now()+t}reset(){this.failureCount=0,this.lockoutUntil=null}getRemainingSeconds(){if(!this.lockoutUntil)return 0;const e=Math.max(0,this.lockoutUntil-Date.now());return Math.ceil(e/1e3)}isLockedOut(){return null!==this.lockoutUntil&&Date.now()<this.lockoutUntil}}const $t="instructor.password.hash";var It=Object.defineProperty,Ct=Object.getOwnPropertyDescriptor,At=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?Ct(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&It(t,n,o),o};let qt=class extends i{constructor(){super(...arguments),this.password="",this.error="",this.remainingSeconds=0,this.rateLimiter=new RateLimiter,this.handlePasswordInput=e=>{const t=e.target;this.password=t.value,this.error=""},this.handleSubmit=async e=>{e.preventDefault();if(!this.rateLimiter.attempt())return this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),this.startCountdown(),void(this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`);try{const e=function(){const e=document.getElementById($t);if(!e){const e=`Instructor password hash not found. Expected element with id="${$t}". Check Oxygen XSL transform configuration.`;throw r(e),new Error(e)}const t=e.textContent?.trim();if(!t){const e="Instructor password hash element is empty. Check Oxygen parameter configuration.";throw r(e),new Error(e)}if(!/^[a-f0-9]{64}$/i.test(t)){const e=`Invalid password hash format. Expected 64 hex characters (SHA-256), got: ${t.substring(0,20)}...`;throw r(e),new Error(e)}return t.toLowerCase()}(),t=(new TextEncoder).encode(this.password),n=await crypto.subtle.digest("SHA-256",t),s=Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,"0")).join(""),o=await async function(e,t){if(e.length!==t.length)return!1;if(0===e.length)return!0;const n=new TextEncoder,s=n.encode(e),r=n.encode(t);try{const e=await crypto.subtle.importKey("raw",s,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),t=await crypto.subtle.sign("HMAC",e,r),n=await crypto.subtle.importKey("raw",r,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),o=await crypto.subtle.sign("HMAC",n,s);if(t.byteLength!==o.byteLength)return!1;const a=new Uint8Array(t),c=new Uint8Array(o);let d=0;for(let s=0;s<a.length;s++)d|=(a[s]??0)^(c[s]??0);return 0===d}catch(o){return console.error("Constant-time comparison failed:",o),!1}}(s,e);o?(this.rateLimiter.reset(),this.password="",this.error="",y(this,"qd:instructor-unlock",{})):(this.error="Invalid password",this.password="")}catch{this.error="Authentication failed",this.password=""}}}disconnectedCallback(){super.disconnectedCallback(),this.countdownInterval&&window.clearInterval(this.countdownInterval)}startCountdown(){this.countdownInterval&&window.clearInterval(this.countdownInterval),this.countdownInterval=window.setInterval(()=>{this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),0===this.remainingSeconds?(this.countdownInterval&&(window.clearInterval(this.countdownInterval),this.countdownInterval=void 0),this.error=""):this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`},1e3)}render(){const e=this.remainingSeconds>0;return Fe`
      <div class="unlock-container">
        ...
        <form @submit=${this.handleSubmit}>
          ...
          ${this.error?Fe`<div class="error" role="alert" aria-live="polite">${this.error}</div>`:""}
    ...
    `}};function kt(e,t){const{totalItems:n,itemHeight:s,viewportHeight:r,bufferSize:o=5}=t,a=Math.max(0,Math.floor(e/s)-o),c=Math.ceil(r/s);return{startIndex:a,endIndex:Math.min(n-1,a+c+2*o),totalHeight:n*s,offsetY:a*s}}qt.styles=Et,At([ot()],qt.prototype,"password",2),At([ot()],qt.prototype,"error",2),At([ot()],qt.prototype,"remainingSeconds",2),qt=At([tt("qd-instructor-unlock")],qt);var _t=Object.defineProperty,Tt=Object.getOwnPropertyDescriptor,Ot=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?Tt(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&_t(t,n,o),o};let Nt=class extends i{constructor(){super(...arguments),this.students=[],this.showModal=!1,this.expandedStudents=new Set,this.virtualListState=null,this.ITEM_HEIGHT=40,this.VIEWPORT_HEIGHT=400,this.BUFFER_SIZE=5,this.handleEscape=e=>{"Escape"===e.key&&this.showModal&&this.handleClose()},this.handleClose=()=>{this.dispatchEvent(new CustomEvent("close"))},this.handleScroll=e=>{const t=e.target.scrollTop;this.virtualListState=kt(t,{totalItems:this.students.length,itemHeight:this.ITEM_HEIGHT,viewportHeight:this.VIEWPORT_HEIGHT,bufferSize:this.BUFFER_SIZE})},this.toggleStudent=e=>{this.expandedStudents.has(e)?this.expandedStudents.delete(e):this.expandedStudents.add(e),this.requestUpdate()}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.handleEscape)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleEscape)}calculateSummary(e){const t=e.attempted>0?Math.round(e.correct/e.attempted*100):0;return{serviceId:e.serviceId,name:e.name,attempted:e.attempted,correct:e.correct,percentage:t}}renderStudentRow(e){const t=this.calculateSummary(e),n=this.expandedStudents.has(e.serviceId);return Fe`
      <tr>
        <td>
          <button
    ...
    `}renderExpandedDetails(e){const t=Object.entries(e.pages);return 0===t.length?Fe`
        <tr>
      ...
      <tr>
        <td colspan="5" style="padding: 0;">
          <table style="margin: 0; width: 100%;">
            ...
            <tbody>
              ${t.map(([e,t])=>{const n=t.answers||[],s=n.filter(e=>null!==e).length,r=n.filter(e=>!0===e?.success).length,o=s>0?Math.round(r/s*100):0;return Fe`
                  <tr>
    ...
    `}render(){if(!this.showModal)return Fe``;const e=[...this.students].sort((e,t)=>e.name.localeCompare(t.name)),t=e.length>=100;t&&!this.virtualListState&&(this.virtualListState=kt(0,{totalItems:e.length,itemHeight:this.ITEM_HEIGHT,viewportHeight:this.VIEWPORT_HEIGHT,bufferSize:this.BUFFER_SIZE}));const n=t&&this.virtualListState?(s=e,r=this.virtualListState,s.slice(r.startIndex,r.endIndex+1)):e;var s,r;const o=t&&this.virtualListState?this.virtualListState.totalHeight:0,a=t&&this.virtualListState?this.virtualListState.offsetY:0;return Fe`
      <div class="modal-overlay" @click=${this.handleClose}>
        ...
        >
          ...
          ${0===e.length?Fe`<p>No student data available.</p>`:Fe`
                <div
                  class="table-container"
                  style=${t?`max-height: ${this.VIEWPORT_HEIGHT}px; overflow-y: auto;`:""}
                  @scroll=${t?this.handleScroll:null}
                >
                  <table>
                    <thead>
                      <tr>
                    ...
                    <tbody
                      style=${t?`height: ${o}px; position: relative;`:""}
                    >
                      ${t?Fe`
                            <tr style="height: 0;">
                              <td colspan="5" style="padding: 0; border: none;">
                                <div style="height: ${a}px;"></div>
                              </td>
                            </tr>
                          `:""}
                      ${n.map(e=>this.renderStudentRow(e))}
                    </tbody>
                  </table>
                </div>
              `}
    ...
    `}};Pt.styles=Et,Dt([rt({type:Array})],Pt.prototype,"students",2),Pt=Dt([tt("qd-instructor-export")],Pt);var Rt=Object.defineProperty,Mt=Object.getOwnPropertyDescriptor,Ht=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?Mt(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&Rt(t,n,o),o};let Ut=class extends i{constructor(){super(...arguments),this.showConfirmDialog=!1,this.confirmText="",this.error="",this.success="",this.handleClearRequest=()=>{this.showConfirmDialog=!0,this.confirmText="",this.error="",this.success=""},this.handleCancelClear=()=>{this.showConfirmDialog=!1,this.confirmText="",this.error=""},this.handleConfirmInput=e=>{const t=e.target;this.confirmText=t.value},this.handleConfirmClear=()=>{if("DELETE ALL DATA"===this.confirmText)try{x(),y(this,"qd:data-cleared",{}),this.success="All quiz data cleared successfully",this.showConfirmDialog=!1,this.confirmText="",this.error="",setTimeout(()=>{this.success=""},3e3)}catch{this.error="Failed to clear data"}else this.error="Confirmation text does not match"}}render(){return Fe`
      <button
      ...
      ${this.success?Fe`
          ...
          `:""}
    `}renderConfirmDialog(){const e="DELETE ALL DATA"===this.confirmText;return Fe`
      <div class="modal-overlay" @click=${this.handleCancelClear}>
        <div class="modal-content" @click=${e=>e.stopPropagation()}>
          ...
          ${this.error?Fe`<div class="error">${this.error}</div>`:""}
    ...
    `],Ft([ot()],Vt.prototype,"unlocked",2),Ft([ot()],Vt.prototype,"showScores",2),Ft([ot()],Vt.prototype,"students",2),Ft([ot()],Vt.prototype,"showStudentAnswers",2),Vt=Ft([tt("qd-instructor")],Vt);var Qt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,Kt=(e,t,n,s)=>{for(var r,o=s>1?void 0:s?Wt(t,n):t,a=e.length-1;a>=0;a--)(r=e[a])&&(o=(s?r(t,n,o):r(o))||o);return s&&o&&Qt(t,n,o),o};let Jt=class extends i{constructor(){super(...arguments),this.dbName="quiz-scores",this.hidden=!0,this.visible=!1,this.indexedDBEntries=[],this.sessionStorageEntries=[],this.handleToggleEntry=e=>{e.expanded=!e.expanded,this.requestUpdate()},this.handleClearSessionStorage=()=>{confirm("Clear all sessionStorage?")&&(sessionStorage.clear(),this.refreshData())},this.handleClearIndexedDB=async()=>{if(confirm(`Clear IndexedDB "${this.dbName}"?`))try{const e=await this.openDatabase();for(const t of Array.from(e.objectStoreNames)){const n=e.transaction(t,"readwrite");n.objectStore(t).clear()}await this.refreshData()}catch(e){console.error("Failed to clear IndexedDB:",e)}},this.handleClose=()=>{this.visible=!1,this.hidden=!0}}connectedCallback(){super.connectedCallback(),this.setupKeyboardShortcut(),this.startRefresh()}disconnectedCallback(){super.disconnectedCallback(),this.stopRefresh()}setupKeyboardShortcut(){document.addEventListener("keydown",e=>{e.ctrlKey&&e.shiftKey&&"D"===e.key&&(e.preventDefault(),this.toggleVisibility())})}toggleVisibility(){this.visible=!this.visible,this.hidden=!this.visible}startRefresh(){this.refreshData(),this.refreshInterval=window.setInterval(()=>{this.refreshData()},1e3)}stopRefresh(){this.refreshInterval&&window.clearInterval(this.refreshInterval)}async refreshData(){await this.refreshIndexedDB(),this.refreshSessionStorage()}async refreshIndexedDB(){try{const e=await this.openDatabase(),t=[];for(const n of Array.from(e.objectStoreNames)){const s=e.transaction(n,"readonly"),r=s.objectStore(n).getAll();await new Promise((e,s)=>{r.onsuccess=()=>{r.result.forEach((e,s)=>{t.push({key:`${n}[${s}]`,value:e,expanded:!1})}),e()},r.onerror=()=>s(new Error(r.error?.message||"IndexedDB request failed"))})}this.indexedDBEntries=t}catch{this.indexedDBEntries=[]}}refreshSessionStorage(){const e=[];for(let t=0;t<sessionStorage.length;t++){const n=sessionStorage.key(t);if(n)try{const t=sessionStorage.getItem(n);e.push({key:n,value:t?JSON.parse(t):t,expanded:!1})}catch{e.push({key:n,value:sessionStorage.getItem(n),expanded:!1})}}this.sessionStorageEntries=e}openDatabase(){return new Promise((e,t)=>{const n=indexedDB.open(this.dbName);n.onsuccess=()=>e(n.result),n.onerror=()=>t(new Error(n.error?.message||"Failed to open database"))})}renderEntry(e){return Fe`
      <div class="entry">
        <div class="entry-key" @click=${()=>this.handleToggleEntry(e)}>
          ${e.expanded?"▼":"▶"} ${e.key}
        </div>
        ${e.expanded?Fe` <div class="entry-value">${JSON.stringify(e.value,null,2)}</div> `:""}
      </div>
    `}render(){return Fe`
      <div class="header">
      ...
      <div class="content">
        <div class="section">
          ...
          ${0===this.indexedDBEntries.length?Fe`<div class="empty">No entries</div>`:this.indexedDBEntries.map(e=>this.renderEntry(e))}
        </div>
        ...
        <div class="section">
          ...
          ${0===this.sessionStorageEntries.length?Fe`<div class="empty">No entries</div>`:this.sessionStorageEntries.map(e=>this.renderEntry(e))}
        </div>
      </div>
    `}};Jt.styles=ce`
    :host {
  ...
  `,Kt([rt({type:String})],Jt.prototype,"dbName",2),Kt([rt({type:Boolean,reflect:!0})],Jt.prototype,"hidden",2),Kt([ot()],Jt.prototype,"visible",2),Kt([ot()],Jt.prototype,"indexedDBEntries",2),Kt([ot()],Jt.prototype,"sessionStorageEntries",2),Jt=Kt([tt("qd-storage-monitor")],Jt);const Gt={statusPanel:".wh_top_menu_and_indexterms_link",storageMonitor:"body"};function Zt(e={}){const t=e.statusPanelContainer||Gt.statusPanel;!function(e){const t=document.querySelector(e);if(!t)return s(`Login component not injected: container '${e}' not found`),null;const n=document.createElement("qd-login");t.appendChild(n),s("Login component injected")}(t),function(e){const t=document.querySelector(e);if(!t)return s(`Status component not injected: container '${e}' not found`),null;const n=document.createElement("qd-status");t.appendChild(n),s("Status component injected")}(t),function(e){const t=document.querySelector(e);if(!t)return s(`Instructor component not injected: container '${e}' not found`),null;const n=document.createElement("qd-instructor");t.appendChild(n),s("Instructor component injected")}(t),function(e){if(!e.debug)return null;const t=e.storageMonitorContainer||Gt.storageMonitor,n=document.querySelector(t);if(!n)return s(`Storage monitor not injected: container '${t}' not found`),null;const r=document.createElement("qd-storage-monitor");e.dbName&&r.setAttribute("dbName",e.dbName),n.appendChild(r),s("Storage monitor injected (debug mode)")}({storageMonitorContainer:e.storageMonitorContainer,dbName:e.dbName,debug:e.debug})}const Yt={red:"qd-badge-red",amber:"qd-badge-amber",green:"qd-badge-green"},Xt={unstarted:"red",incomplete:"amber",complete:"green"};function en(e){const t=function(e,t){if(!e||!t?.pages)return"unstarted";const n=t.pages[e];return n?.state??"unstarted"}(e.getAttribute("data-page-id"),w(l.CACHE));!function(e,t){Object.values(Yt).forEach(t=>{e.classList.remove(t)});const n=Yt[Xt[t]];e.classList.add(n)}(e,t)}function tn(){const e=document.querySelectorAll(".quizPageBtn"),t=w(l.CACHE),n="true"===sessionStorage.getItem(l.INSTRUCTOR);if(!t||n)return e.forEach(e=>{Object.values(Yt).forEach(t=>{e.classList.remove(t)})}),void s(n?`Removed badge styling from ${e.length} page links (instructor mode)`:`Removed badge styling from ${e.length} page links (no session)`);e.forEach(e=>{en(e)}),s(`Updated ${e.length} page badges`)}function nn(e){const t=e,{pageId:n}=t.detail,r=document.querySelector(`[data-page-id="${n}"]`);r&&r.classList.contains("quizPageBtn")&&(en(r),s(`Updated badge for page ${n}`))}function sn(){s("Cache rebuilt, refreshing all badges"),tn()}function rn(){s("Logout detected, removing all badge styling");const e=document.querySelectorAll(".quizPageBtn");e.forEach(e=>{Object.values(Yt).forEach(t=>{e.classList.remove(t)})}),s(`Removed badge styling from ${e.length} page links`)}const on={initialized:!1};async function an(e={}){if(on.initialized)return void o("Bootstrap already initialized, skipping");s("Bootstrapping Sonar Quiz System..."),function(){if(document.getElementById("qd-global-styles"))return;const e=document.createElement("style");e.id="qd-global-styles",e.textContent="\n    /* Sonar Quiz System - Global Styles */\n    .qd-hidden {\n      display: none !important;\n    }\n\n    /* Quiz table interactive mode styles */\n    .qd-quiz-interactive .qd-quiz-input {\n      width: 100%;\n      padding: 0.5rem;\n      font-size: 1rem;\n      border: 1px solid #ccc;\n      border-radius: 4px;\n    }\n\n    /* Validation styling for answer cells */\n    .qd-quiz-interactive .qd-answer-correct {\n      background-color: #d4edda !important;\n      border-color: #28a745 !important;\n    }\n\n    .qd-quiz-interactive .qd-answer-incorrect {\n      background-color: #f8d7da !important;\n      border-color: #dc3545 !important;\n    }\n\n    /* Home page badge styles (R/A/G indicators) */\n    .qd-badge-red {\n      border-left: 4px solid #d32f2f !important;\n      background-color: #ffebee !important;\n    }\n\n    .qd-badge-amber {\n      border-left: 4px solid #ff9800 !important;\n      background-color: #fff3e0 !important;\n    }\n\n    .qd-badge-green {\n      border-left: 4px solid #4caf50 !important;\n      background-color: #e8f5e9 !important;\n    }\n\n    /* Instructor mode: Student answers display */\n    .qd-student-answers {\n      margin-top: 12px;\n      padding: 8px;\n      background: #f8f9fa;\n      border-radius: 4px;\n      border: 1px solid #dee2e6;\n    }\n\n    .qd-student-answer {\n      font-size: 12px;\n      padding: 4px 0;\n      line-height: 1.4;\n    }\n\n    .qd-student-answer.qd-correct {\n      color: #28a745;\n    }\n\n    .qd-student-answer.qd-incorrect {\n      color: #dc3545;\n    }\n\n    .qd-student-name {\n      font-weight: 600;\n    }\n\n    .qd-student-answer-text {\n      margin: 0 4px;\n    }\n\n    .qd-timestamp {\n      color: #6c757d;\n      font-size: 11px;\n      margin-left: 8px;\n    }\n  ",document.head.appendChild(e),s("Global styles injected")}();const t=P(e.dbName||"BrowserTest");await t.init();const n=new EventCoordinator;n.initialize(),on.eventCoordinator=n;const r=new SessionCoordinator;r.initialize(),on.sessionCoordinator=r,Zt({statusPanelContainer:e.statusPanelContainer,storageMonitorContainer:e.storageMonitorContainer,dbName:e.dbName,debug:e.debug}),!1!==e.autoEnhanceQuizTables&&function(){const e=document.querySelectorAll("table.qd-quiz");if(0===e.length)return void s("No quiz tables found to enhance");s(`Enhancing ${e.length} quiz table(s) in non-interactive mode...`);let t=0;for(const s of Array.from(e))try{F(s,{interactive:!1}),t++}catch(n){o(`Failed to enhance quiz table: ${n.message}`)}s(`Enhanced ${t} of ${e.length} quiz table(s) (non-interactive)`)}(),!1!==e.autoEnhanceAnalysisTables&&function(){const e=document.querySelectorAll("table.qd-analysis");if(0===e.length)return void s("No analysis tables found to enhance");s(`Enhancing ${e.length} analysis table(s) in non-interactive mode...`);let t=0;for(const s of Array.from(e))try{ne(s,{interactive:!1}),t++}catch(n){o(`Failed to enhance analysis table: ${n.message}`)}s(`Enhanced ${t} of ${e.length} analysis table(s) (non-interactive)`)}(),!1!==e.autoEnhanceHomeBadges&&function(){const e=document.querySelectorAll(".quizPageBtn");if(0===e.length)return void s("No .quizPageBtn links found, skipping badge enhancement");s(`Enhancing home page badges for ${e.length} link(s)...`);try{document.querySelectorAll(".quizPageBtn").forEach(e=>{const t=function(e){const t=e.getAttribute("href");return t&&t.substring(t.lastIndexOf("/")+1).replace(/\.html?$/i,"")||null}(e);t?(e.setAttribute("data-page-id",t),s(`Set data-page-id="${t}" for link: ${e.textContent?.trim()}`)):s(`Failed to extract pageId from href: ${e.getAttribute("href")}`)}),tn(),document.addEventListener("qd:state-changed",nn),document.addEventListener("qd:cache-rebuild",sn),document.addEventListener("qd:logout",rn),s("Home page badges enhanced with event listeners"),s("Home page badges enhanced")}catch(t){o(`Failed to enhance home badges: ${t.message}`)}}(),await async function(){const e=w(l.SESSION);if(!e)return void s("No existing session, tables remain in non-interactive mode");if("true"===sessionStorage.getItem(l.INSTRUCTOR)){s("Instructor session detected, revealing answers in non-interactive tables");return void document.querySelectorAll("table.qd-quiz").forEach(e=>{const t=W(e);if(!t)return;e.querySelectorAll("td:nth-child(2), th:nth-child(2)").forEach((e,n)=>{if(e.classList.remove("qd-hidden"),n>0&&e instanceof HTMLTableCellElement){const s=n-1,r=t.parsed.questions[s];r&&(e.textContent=r.correctAnswer)}});e.querySelectorAll("td:nth-child(3), th:nth-child(3)").forEach(e=>e.classList.remove("qd-hidden"))})}s(`Existing session detected for ${e.serviceId}, upgrading tables to interactive mode`);const t=P();let n=w(l.CACHE);if(!n){s("Cache not found, rebuilding from IndexedDB...");try{const r=await t.loadStudentRecord(e);n=t.buildCache(r),S(l.CACHE,n),s(`Cache rebuilt from IndexedDB: ${n.totals.total} total questions`)}catch{o("Failed to rebuild cache from IndexedDB, using empty cache"),n={totals:{total:0,answered:0,correct:0},pages:{}},S(l.CACHE,n)}}const r=window.location.pathname,a=r.substring(r.lastIndexOf("/")+1).replace(/\.html?$/i,"");if(!a)return void s("No pageId found, skipping table upgrade");const c=document.querySelectorAll("table.qd-quiz");c.length>0&&(s(`Upgrading ${c.length} quiz table(s) to interactive mode...`),c.forEach(e=>{F(e,{interactive:!0,pageId:a})}));const d=document.querySelectorAll("table.qd-analysis");d.length>0&&(s(`Upgrading ${d.length} analysis table(s) to interactive mode...`),d.forEach(e=>{ne(e,{interactive:!0,pageId:a})}))}(),on.initialized=!0,s("Bootstrap complete")}if("undefined"!=typeof window){const e=()=>{s("Auto-initializing Sonar Quiz System");const e=function(){s("Reading configuration from DOM...");const e={statusPanelContainer:gt(lt,it),titleSelector:gt(ut,at),instructorHash:gt(ht,ct),dbName:gt(pt,dt)};return s("Configuration loaded:",e),e}();an({debug:true,dbName:e.dbName,statusPanelContainer:e.statusPanelContainer,autoEnhanceQuizTables:!0,autoEnhanceAnalysisTables:!0,autoEnhanceHomeBadges:!0})};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{e()}):e()}return e.BUILD_DATE="2025-11-19",e.DEFAULT_CONTAINERS=Gt,e.Debouncer=Debouncer,e.SCHEMA_VERSION=1,e.SESSION_TIMEOUT_MS=d,e.STORAGE_KEYS=l,e.VERSION="0.1.0-phase3.1",e.bootstrap=an,e.calculateCompletionState=T,e.cleanup=function(){on.initialized?(s("Cleaning up bootstrap resources..."),on.eventCoordinator?.cleanup(),on.sessionCoordinator?.cleanup(),on.initialized=!1,on.eventCoordinator=void 0,on.sessionCoordinator=void 0,s("Bootstrap cleanup complete")):o("Bootstrap not initialized, nothing to cleanup")},e.clearQuizData=x,e.enhanceAnalysisTable=ne,e.enhanceQuizTable=F,e.error=r,e.generateCellKey=Y,e.generateTableId=Z,e.getAnalysisTableMetadata=function(e){return te.get(e)},e.getJSON=w,e.getQuizTableMetadata=W,e.info=s,e.injectComponents=Zt,e.isAnalysisTableEnhanced=function(e){return te.has(e)},e.isCellEditable=X,e.isInitialized=function(){return on.initialized},e.isQuizTableEnhanced=function(e){return B.has(e)},e.parseAnalysisTable=ee,e.parseQuizTable=a,e.setJSON=S,e.validateAnswer=c,e.warn=o,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),e}({});
