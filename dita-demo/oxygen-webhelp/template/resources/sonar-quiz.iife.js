...
/**
  ...
  `,Bt([ht({type:Boolean,reflect:!0})],Vt.prototype,"open",2),Bt([ht({type:String})],Vt.prototype,"title",2),Bt([ht({type:String})],Vt.prototype,"message",2),Bt([ht({type:String})],Vt.prototype,"confirmText",2),Bt([ht({type:String})],Vt.prototype,"cancelText",2),Bt([ht({type:Boolean})],Vt.prototype,"destructive",2),Vt=Bt([ct("qd-confirm-dialog")],Vt);var Qt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,Wt=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Kt(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Qt(n,s,a),a};let Jt=class extends at{constructor(){super(...arguments),this.panelType="login",this.handleClick=()=>{this.dispatchEvent(new CustomEvent("qd:help-open",{detail:{panelType:this.panelType},bubbles:!0,composed:!0}))}}render(){return Ye`
      <button
        class="help-icon"
  ...
  `,cn([pt()],ln.prototype,"total",2),cn([pt()],ln.prototype,"correct",2),cn([pt()],ln.prototype,"percentage",2),cn([pt()],ln.prototype,"statusColor",2),cn([pt()],ln.prototype,"name",2),cn([pt()],ln.prototype,"serviceId",2),cn([pt()],ln.prototype,"helpOpen",2),ln=cn([ct("qd-status")],ln);const un=me`
  :host {
    display: inline-block;
    font-family:
      system-ui,
