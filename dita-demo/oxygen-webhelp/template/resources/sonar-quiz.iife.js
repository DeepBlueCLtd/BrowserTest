...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */function ht(e){return ut({...e,state:!0,attribute:!1})}const pt=".wh_top_menu_and_indexterms_link",gt=".wh_publication_title .title",mt="",ft="BrowserTest",bt="qd-status-container",vt="qd-title-selector",yt="qd-instructor-hash",xt="qd-db-name";function wt(e,t){const n=document.querySelector(`#${e}`);if(!n)return t;const o=n.textContent?.trim()||"";return""===o?(r(`Config element #${e} found but empty, using default: "${t}"`),t):(s(`Config read from #${e}: "${o}"`),o)}async function St(e){const t=(new TextEncoder).encode(e),n=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,"0")).join("")}function Et(e){return`${l.PIN_ATTEMPTS}:${e}`}function Ct(e){const t=Et(e),n=sessionStorage.getItem(t);if(!n)return null;try{return JSON.parse(n)}catch{return null}}function $t(e){const t=Ct(e);if(!t||!t.lockoutUntil)return{isLocked:!1,remainingMs:0};const n=new Date(t.lockoutUntil).getTime(),s=Date.now();return n>s?{isLocked:!0,remainingMs:n-s}:(It(e),{isLocked:!1,remainingMs:0})}function It(e){const n=Ct(e);n&&n.attempts>0&&s(`Cleared ${n.attempts} failed PIN attempts for ${t(e)} on successful login`);const o=Et(e);sessionStorage.removeItem(o)}var kt=Object.getOwnPropertyDescriptor;let At=class extends i{render(){return Ge`
  ...
  `,At=((e,t,n,s)=>{for(var o,r=s>1?void 0:s?kt(t,n):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=o(r)||r);return r})([dt("qd-build-info")],At);var qt=Object.defineProperty,Tt=Object.getOwnPropertyDescriptor,Nt=(e,t,n,s)=>{for(var o,r=s>1?void 0:s?Tt(t,n):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=(s?o(t,n,r):o(r))||r);return s&&r&&qt(t,n,r),r};let _t=class extends i{constructor(){super(...arguments),this.title="Sonar Quiz System",this.name="",this.serviceId="",this.instructorPassword="",this.showInstructorModal=!1,this.modalOverlay=null,this.errorMessage="",this.instructorError="",this.isSubmitting=!1,this.pin="",this.lockoutSeconds=0,this.lockoutInterval=null,this.handleLogoutEvent=()=>{this.name="",this.serviceId="",this.instructorPassword="",this.errorMessage="",this.instructorError="",this.isSubmitting=!1,this.showInstructorModal=!1,this.pin="",this.lockoutSeconds=0,this.lockoutInterval&&(clearInterval(this.lockoutInterval),this.lockoutInterval=null),this.cleanupModal(),this.updateVisibility()},this.handleEscape=e=>{"Escape"===e.key&&this.showInstructorModal&&this.closeInstructorModal()}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),document.addEventListener("keydown",this.handleEscape),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleEscape),document.removeEventListener("qd:logout",this.handleLogoutEvent),this.cleanupModal(),this.lockoutInterval&&(clearInterval(this.lockoutInterval),this.lockoutInterval=null)}cleanupModal(){this.modalOverlay&&(this.modalOverlay.remove(),this.modalOverlay=null)}firstUpdated(){this.setAttribute("data-ready","")}updateVisibility(){S(l.SESSION)?this.removeAttribute("data-show"):this.setAttribute("data-show","")}render(){return Ge`
  ...
  `,Nt([ut({type:String})],_t.prototype,"title",2),Nt([ht()],_t.prototype,"name",2),Nt([ht()],_t.prototype,"serviceId",2),Nt([ht()],_t.prototype,"instructorPassword",2),Nt([ht()],_t.prototype,"showInstructorModal",2),Nt([ht()],_t.prototype,"errorMessage",2),Nt([ht()],_t.prototype,"instructorError",2),Nt([ht()],_t.prototype,"isSubmitting",2),Nt([ht()],_t.prototype,"pin",2),Nt([ht()],_t.prototype,"lockoutSeconds",2),_t=Nt([dt("qd-login")],_t);var zt=Object.defineProperty,Lt=Object.getOwnPropertyDescriptor,Pt=(e,t,n,s)=>{for(var o,r=s>1?void 0:s?Lt(t,n):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=(s?o(t,n,r):o(r))||r);return s&&r&&zt(t,n,r),r};let Ot=class extends i{constructor(){super(...arguments),this.total=0,this.correct=0,this.percentage=0,this.statusColor="red",this.handleStateChanged=()=>{this.loadCache()},this.handleLogin=()=>{this.updateVisibility(),this.loadCache()},this.handleLogoutEvent=()=>{this.updateVisibility()}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),this.loadCache(),document.addEventListener("qd:state-changed",this.handleStateChanged),document.addEventListener("qd:login",this.handleLogin),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:state-changed",this.handleStateChanged),document.removeEventListener("qd:login",this.handleLogin),document.removeEventListener("qd:logout",this.handleLogoutEvent)}render(){return Ge`
    ...
    `}loadCache(){const e=S(l.CACHE);if(!e)return this.total=0,this.correct=0,this.percentage=0,void(this.statusColor="red");this.total=e.totals.total,this.correct=e.totals.correct,this.percentage=this.calculatePercentage(e.totals.total,e.totals.correct),this.statusColor=this.calculateStatusColor(e.totals.total,e.totals.correct)}calculatePercentage(e,t){return 0===e?0:Math.round(t/e*100)}calculateStatusColor(e,t){return 0===e||0===t?"red":t===e?"green":"amber"}updateVisibility(){const e=S(l.SESSION),t="true"===sessionStorage.getItem(l.INSTRUCTOR);e&&!t?this.setAttribute("data-show",""):this.removeAttribute("data-show")}handleLogout(){const e=S(l.SESSION);(new SessionService).clearSession();const t=new CustomEvent("qd:logout",{detail:{serviceId:e?.serviceId||"unknown"},bubbles:!0,composed:!0});this.dispatchEvent(t)}};Ot.styles=ge`
    :host {
  ...
  `,Pt([ht()],Ot.prototype,"total",2),Pt([ht()],Ot.prototype,"correct",2),Pt([ht()],Ot.prototype,"percentage",2),Pt([ht()],Ot.prototype,"statusColor",2),Ot=Pt([dt("qd-status")],Ot);const Dt=ge`
  :host {
    display: inline-block;
    font-family:
      system-ui,
...
`;class RateLimiter{constructor(){this.failureCount=0,this.lockoutUntil=null}attempt(){return!(this.lockoutUntil&&Date.now()<this.lockoutUntil)&&(this.lockoutUntil&&Date.now()>=this.lockoutUntil&&(this.lockoutUntil=null),!0)}recordFailure(){this.failureCount++;const e=[2e3,4e3,8e3,16e3,3e4],t=e[Math.min(this.failureCount-1,e.length-1)]??3e4;this.lockoutUntil=Date.now()+t}reset(){this.failureCount=0,this.lockoutUntil=null}getRemainingSeconds(){if(!this.lockoutUntil)return 0;const e=Math.max(0,this.lockoutUntil-Date.now());return Math.ceil(e/1e3)}isLockedOut(){return null!==this.lockoutUntil&&Date.now()<this.lockoutUntil}}const Mt="instructor.password.hash";var Rt=Object.defineProperty,Bt=Object.getOwnPropertyDescriptor,Ht=(e,t,n,s)=>{for(var o,r=s>1?void 0:s?Bt(t,n):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=(s?o(t,n,r):o(r))||r);return s&&r&&Rt(t,n,r),r};let jt=class extends i{constructor(){super(...arguments),this.password="",this.error="",this.remainingSeconds=0,this.rateLimiter=new RateLimiter,this.handlePasswordInput=e=>{const t=e.target;this.password=t.value,this.error=""},this.handleSubmit=async e=>{e.preventDefault();if(!this.rateLimiter.attempt())return this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),this.startCountdown(),void(this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`);try{const e=function(){const e=document.getElementById(Mt);if(!e){const e=`Instructor password hash not found. Expected element with id="${Mt}". Check Oxygen XSL transform configuration.`;throw o(e),new Error(e)}const t=e.textContent?.trim();if(!t){const e="Instructor password hash element is empty. Check Oxygen parameter configuration.";throw o(e),new Error(e)}if(!/^[a-f0-9]{64}$/i.test(t)){const e=`Invalid password hash format. Expected 64 hex characters (SHA-256), got: ${t.substring(0,20)}...`;throw o(e),new Error(e)}return t.toLowerCase()}(),t=(new TextEncoder).encode(this.password),n=await crypto.subtle.digest("SHA-256",t),s=Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,"0")).join(""),r=await async function(e,t){if(e.length!==t.length)return!1;if(0===e.length)return!0;const n=new TextEncoder,s=n.encode(e),o=n.encode(t);try{const e=await crypto.subtle.importKey("raw",s,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),t=await crypto.subtle.sign("HMAC",e,o),n=await crypto.subtle.importKey("raw",o,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),r=await crypto.subtle.sign("HMAC",n,s);if(t.byteLength!==r.byteLength)return!1;const a=new Uint8Array(t),d=new Uint8Array(r);let c=0;for(let s=0;s<a.length;s++)c|=(a[s]??0)^(d[s]??0);return 0===c}catch(r){return console.error("Constant-time comparison failed:",r),!1}}(s,e);r?(this.rateLimiter.reset(),this.password="",this.error="",w(this,"qd:instructor-unlock",{})):(this.error="Invalid password",this.password="")}catch{this.error="Authentication failed",this.password=""}}}disconnectedCallback(){super.disconnectedCallback(),this.countdownInterval&&window.clearInterval(this.countdownInterval)}startCountdown(){this.countdownInterval&&window.clearInterval(this.countdownInterval),this.countdownInterval=window.setInterval(()=>{this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),0===this.remainingSeconds?(this.countdownInterval&&(window.clearInterval(this.countdownInterval),this.countdownInterval=void 0),this.error=""):this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`},1e3)}render(){const e=this.remainingSeconds>0;return Ge`
    ...
    `}};Gt.styles=Dt,Wt([ut({type:Array})],Gt.prototype,"students",2),Gt=Wt([dt("qd-instructor-export")],Gt);var Yt=Object.defineProperty,Zt=Object.getOwnPropertyDescriptor,Xt=(e,t,n,s)=>{for(var o,r=s>1?void 0:s?Zt(t,n):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=(s?o(t,n,r):o(r))||r);return s&&r&&Yt(t,n,r),r};let en=class extends i{constructor(){super(...arguments),this.showConfirmDialog=!1,this.confirmText="",this.error="",this.success="",this.modalContainer=null,this.handleClearRequest=()=>{this.showConfirmDialog=!0,this.confirmText="",this.error="",this.success=""},this.handleCancelClear=()=>{this.showConfirmDialog=!1,this.confirmText="",this.error=""},this.handleConfirmInput=e=>{const t=e.target;this.confirmText=t.value},this.handleConfirmClear=()=>{if("DELETE ALL DATA"===this.confirmText)try{C(),w(this,"qd:data-cleared",{}),this.success="All quiz data cleared successfully",this.showConfirmDialog=!1,this.confirmText="",this.error="",setTimeout(()=>{this.success=""},3e3)}catch{this.error="Failed to clear data"}else this.error="Confirmation text does not match"}}disconnectedCallback(){super.disconnectedCallback(),this.removeModalFromBody()}updated(e){super.updated(e),e.has("showConfirmDialog")&&(this.showConfirmDialog?this.renderModalToBody():this.removeModalFromBody()),this.showConfirmDialog&&(e.has("confirmText")||e.has("error"))&&this.renderModalToBody()}renderModalToBody(){this.modalContainer||(this.modalContainer=document.createElement("div"),this.modalContainer.className="qd-manage-modal-container",document.body.appendChild(this.modalContainer)),rt(this.renderConfirmDialog(),this.modalContainer)}removeModalFromBody(){this.modalContainer&&(this.modalContainer.remove(),this.modalContainer=null)}render(){return Ge`
      <button
  ...
  `,sn([ut({type:Array})],on.prototype,"students",2),sn([ut({type:Boolean})],on.prototype,"showModal",2),sn([ht()],on.prototype,"searchText",2),sn([ht()],on.prototype,"confirmingStudent",2),on=sn([dt("qd-pin-reset-dialog")],on);var rn=Object.defineProperty,an=Object.getOwnPropertyDescriptor,dn=(e,t,n,s)=>{for(var o,r=s>1?void 0:s?an(t,n):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=(s?o(t,n,r):o(r))||r);return s&&r&&rn(t,n,r),r};let cn=class extends i{constructor(){super(...arguments),this.unlocked=!1,this.showScores=!1,this.students=[],this.showStudentAnswers=!1,this.showPinReset=!1,this.handleLoginEvent=e=>{const t=e,n=t.detail?.role;this.updateVisibility(),"instructor"===n&&this.unlock()},this.handleLogoutEvent=()=>{this.updateVisibility(),this.lock()},this.handleResetPins=async()=>{const e=S(l.SESSION);if(e){try{const{getStorageService:t}=await Promise.resolve().then(()=>V),n=t(),s=await n.getStudentsByRelease(e.release);this.students=s}catch(t){console.error("Failed to load students:",t),this.students=[]}this.showPinReset=!0}},this.handleClosePinReset=()=>{this.showPinReset=!1},this.handlePinReset=()=>{this.dispatchEvent(new CustomEvent("qd:pin-reset",{bubbles:!0,composed:!0}))},this.handleUnlock=()=>{this.unlocked=!0,this.dispatchEvent(new CustomEvent("qd:instructor-unlock",{bubbles:!0,composed:!0}))},this.handleViewScores=async()=>{const e=S(l.SESSION);if(e){try{const{getStorageService:t}=await Promise.resolve().then(()=>V),n=t(),s=await n.getStudentsByRelease(e.release);this.students=s}catch(t){console.error("Failed to load students:",t),this.students=[]}this.showScores=!0}},this.handleCloseScores=()=>{this.showScores=!1},this.handleDataCleared=()=>{this.dispatchEvent(new CustomEvent("qd:data-cleared",{bubbles:!0,composed:!0})),this.students=[]},this.handleLogout=()=>{const e=S(l.SESSION);(new SessionService).clearSession(),this.dispatchEvent(new CustomEvent("qd:logout",{detail:{serviceId:e?.serviceId||"unknown"},bubbles:!0,composed:!0}))},this.handleToggleStudentAnswers=async e=>{const t=e.target;if(this.showStudentAnswers=t.checked,this.showStudentAnswers&&0===this.students.length){const e=S(l.SESSION);if(e)try{const{getStorageService:t}=await Promise.resolve().then(()=>V),n=t(),s=await n.getStudentsByRelease(e.release);this.students=s}catch(s){console.error("Failed to load students for toggle:",s)}}const n=this.showStudentAnswers?"qd:instructor-show-answers":"qd:instructor-hide-answers";this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0})),sessionStorage.setItem("qd/instructor/showAnswers",String(this.showStudentAnswers))}}connectedCallback(){super.connectedCallback(),this.updateVisibility();const e="true"===sessionStorage.getItem(l.INSTRUCTOR);e&&this.unlock();const t=sessionStorage.getItem("qd/instructor/showAnswers");null!==t&&(this.showStudentAnswers="true"===t,this.showStudentAnswers&&e&&setTimeout(()=>{this.dispatchEvent(new CustomEvent("qd:instructor-show-answers",{bubbles:!0,composed:!0}))},100)),document.addEventListener("qd:login",this.handleLoginEvent),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:login",this.handleLoginEvent),document.removeEventListener("qd:logout",this.handleLogoutEvent)}updateVisibility(){"true"===sessionStorage.getItem(l.INSTRUCTOR)?this.setAttribute("data-show",""):this.removeAttribute("data-show")}setStudents(e){this.students=e}unlock(){this.unlocked=!0}lock(){this.unlocked=!1,this.showScores=!1,this.showPinReset=!1}render(){return this.unlocked?Ge`
    ...
    `],dn([ht()],cn.prototype,"unlocked",2),dn([ht()],cn.prototype,"showScores",2),dn([ht()],cn.prototype,"students",2),dn([ht()],cn.prototype,"showStudentAnswers",2),dn([ht()],cn.prototype,"showPinReset",2),cn=dn([dt("qd-instructor")],cn);var ln=Object.defineProperty,un=Object.getOwnPropertyDescriptor,hn=(e,t,n,s)=>{for(var o,r=s>1?void 0:s?un(t,n):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=(s?o(t,n,r):o(r))||r);return s&&r&&ln(t,n,r),r};let pn=class extends i{constructor(){super(...arguments),this.dbName="quiz-scores",this.hidden=!0,this.visible=!1,this.indexedDBEntries=[],this.sessionStorageEntries=[],this.handleToggleEntry=e=>{e.expanded=!e.expanded,this.requestUpdate()},this.handleClearSessionStorage=()=>{confirm("Clear all sessionStorage?")&&(sessionStorage.clear(),this.refreshData())},this.handleClearIndexedDB=async()=>{if(confirm(`Clear IndexedDB "${this.dbName}"?`))try{const e=await this.openDatabase();for(const t of Array.from(e.objectStoreNames)){const n=e.transaction(t,"readwrite");n.objectStore(t).clear()}await this.refreshData()}catch(e){console.error("Failed to clear IndexedDB:",e)}},this.handleClose=()=>{this.visible=!1,this.hidden=!0}}connectedCallback(){super.connectedCallback(),this.setupKeyboardShortcut(),this.startRefresh()}disconnectedCallback(){super.disconnectedCallback(),this.stopRefresh()}setupKeyboardShortcut(){document.addEventListener("keydown",e=>{e.ctrlKey&&e.shiftKey&&"D"===e.key&&(e.preventDefault(),this.toggleVisibility())})}toggleVisibility(){this.visible=!this.visible,this.hidden=!this.visible}startRefresh(){this.refreshData(),this.refreshInterval=window.setInterval(()=>{this.refreshData()},1e3)}stopRefresh(){this.refreshInterval&&window.clearInterval(this.refreshInterval)}async refreshData(){await this.refreshIndexedDB(),this.refreshSessionStorage()}async refreshIndexedDB(){try{const e=await this.openDatabase(),t=[];for(const n of Array.from(e.objectStoreNames)){const s=e.transaction(n,"readonly"),o=s.objectStore(n).getAll();await new Promise((e,s)=>{o.onsuccess=()=>{o.result.forEach((e,s)=>{t.push({key:`${n}[${s}]`,value:e,expanded:!1})}),e()},o.onerror=()=>s(new Error(o.error?.message||"IndexedDB request failed"))})}this.indexedDBEntries=t}catch{this.indexedDBEntries=[]}}refreshSessionStorage(){const e=[];for(let t=0;t<sessionStorage.length;t++){const n=sessionStorage.key(t);if(n)try{const t=sessionStorage.getItem(n);e.push({key:n,value:t?JSON.parse(t):t,expanded:!1})}catch{e.push({key:n,value:sessionStorage.getItem(n),expanded:!1})}}this.sessionStorageEntries=e}openDatabase(){return new Promise((e,t)=>{const n=indexedDB.open(this.dbName);n.onsuccess=()=>e(n.result),n.onerror=()=>t(new Error(n.error?.message||"Failed to open database"))})}renderEntry(e){return Ge`
      <div class="entry">
        <div class="entry-key" @click=${()=>this.handleToggleEntry(e)}>
          ${e.expanded?"▼":"▶"} ${e.key}
        </div>
        ${e.expanded?Ge` <div class="entry-value">${JSON.stringify(e.value,null,2)}</div> `:""}
      </div>
    `}render(){return Ge`
      <div class="header">
      ...
      <div class="content">
        <div class="section">
          ...
          ${0===this.indexedDBEntries.length?Ge`<div class="empty">No entries</div>`:this.indexedDBEntries.map(e=>this.renderEntry(e))}
        </div>
        ...
        <div class="section">
          ...
          ${0===this.sessionStorageEntries.length?Ge`<div class="empty">No entries</div>`:this.sessionStorageEntries.map(e=>this.renderEntry(e))}
        </div>
      </div>
    `}};pn.styles=ge`
    :host {
  ...
  `,hn([ut({type:String})],pn.prototype,"dbName",2),hn([ut({type:Boolean,reflect:!0})],pn.prototype,"hidden",2),hn([ht()],pn.prototype,"visible",2),hn([ht()],pn.prototype,"indexedDBEntries",2),hn([ht()],pn.prototype,"sessionStorageEntries",2),pn=hn([dt("qd-storage-monitor")],pn);const gn={statusPanel:".wh_top_menu_and_indexterms_link",storageMonitor:"body"};function mn(e={}){const t=e.statusPanelContainer||gn.statusPanel;!function(e){const t=document.querySelector(e);if(!t)return s(`Login component not injected: container '${e}' not found`),null;const n=document.createElement("qd-login");t.appendChild(n),s("Login component injected")}(t),function(e){const t=document.querySelector(e);if(!t)return s(`Status component not injected: container '${e}' not found`),null;const n=document.createElement("qd-status");t.appendChild(n),s("Status component injected")}(t),function(e){const t=document.querySelector(e);if(!t)return s(`Instructor component not injected: container '${e}' not found`),null;const n=document.createElement("qd-instructor");t.appendChild(n),s("Instructor component injected")}(t),function(e){if(!e.debug)return null;const t=e.storageMonitorContainer||gn.storageMonitor,n=document.querySelector(t);if(!n)return s(`Storage monitor not injected: container '${t}' not found`),null;const o=document.createElement("qd-storage-monitor");e.dbName&&o.setAttribute("dbName",e.dbName),n.appendChild(o),s("Storage monitor injected (debug mode)")}({storageMonitorContainer:e.storageMonitorContainer,dbName:e.dbName,debug:e.debug})}const fn={red:"qd-badge-red",amber:"qd-badge-amber",green:"qd-badge-green"},bn={unstarted:"red",incomplete:"amber",complete:"green"};function vn(e){const t=function(e,t){if(!e||!t?.pages)return"unstarted";const n=t.pages[e];return n?.state??"unstarted"}(e.getAttribute("data-page-id"),S(l.CACHE));!function(e,t){Object.values(fn).forEach(t=>{e.classList.remove(t)});const n=fn[bn[t]];e.classList.add(n)}(e,t)}function yn(){const e=document.querySelectorAll(".quizPageBtn"),t=S(l.CACHE),n="true"===sessionStorage.getItem(l.INSTRUCTOR);if(!t||n)return e.forEach(e=>{Object.values(fn).forEach(t=>{e.classList.remove(t)})}),void s(n?`Removed badge styling from ${e.length} page links (instructor mode)`:`Removed badge styling from ${e.length} page links (no session)`);e.forEach(e=>{vn(e)}),s(`Updated ${e.length} page badges`)}function xn(e){const t=e,{pageId:n}=t.detail,o=document.querySelector(`[data-page-id="${n}"]`);o&&o.classList.contains("quizPageBtn")&&(vn(o),s(`Updated badge for page ${n}`))}function wn(){s("Cache rebuilt, refreshing all badges"),yn()}function Sn(){s("Logout detected, removing all badge styling");const e=document.querySelectorAll(".quizPageBtn");e.forEach(e=>{Object.values(fn).forEach(t=>{e.classList.remove(t)})}),s(`Removed badge styling from ${e.length} page links`)}const En={initialized:!1};async function Cn(e={}){if(En.initialized)return void r("Bootstrap already initialized, skipping");s("Bootstrapping Sonar Quiz System..."),function(){if(document.getElementById("qd-global-styles"))return;const e=document.createElement("style");e.id="qd-global-styles",e.textContent="\n    /* Sonar Quiz System - Global Styles */\n    .qd-hidden {\n      display: none !important;\n    }\n\n    /* Quiz table interactive mode styles */\n    .qd-quiz-interactive .qd-quiz-input {\n      width: 100%;\n      padding: 0.5rem;\n      font-size: 1rem;\n      border: 1px solid #ccc;\n      border-radius: 4px;\n    }\n\n    /* Validation styling for answer cells */\n    .qd-quiz-interactive .qd-answer-correct {\n      background-color: #d4edda !important;\n      border-color: #28a745 !important;\n    }\n\n    .qd-quiz-interactive .qd-answer-incorrect {\n      background-color: #f8d7da !important;\n      border-color: #dc3545 !important;\n    }\n\n    /* Home page badge styles (R/A/G indicators) */\n    .qd-badge-red {\n      border-left: 4px solid #d32f2f !important;\n      background-color: #ffebee !important;\n    }\n\n    .qd-badge-amber {\n      border-left: 4px solid #ff9800 !important;\n      background-color: #fff3e0 !important;\n    }\n\n    .qd-badge-green {\n      border-left: 4px solid #4caf50 !important;\n      background-color: #e8f5e9 !important;\n    }\n\n    /* Instructor mode: Student answers display */\n    .qd-student-answers {\n      margin-top: 12px;\n      padding: 8px;\n      background: #f8f9fa;\n      border-radius: 4px;\n      border: 1px solid #dee2e6;\n    }\n\n    .qd-student-answer {\n      font-size: 12px;\n      padding: 4px 0;\n      line-height: 1.4;\n    }\n\n    .qd-student-answer.qd-correct {\n      color: #28a745;\n    }\n\n    .qd-student-answer.qd-incorrect {\n      color: #dc3545;\n    }\n\n    .qd-student-name {\n      font-weight: 600;\n    }\n\n    .qd-student-answer-text {\n      margin: 0 4px;\n    }\n\n    .qd-timestamp {\n      color: #6c757d;\n      font-size: 11px;\n      margin-left: 8px;\n    }\n  ",document.head.appendChild(e),s("Global styles injected")}();const t=F(e.dbName||"BrowserTest");await t.init();const n=new EventCoordinator;n.initialize(),En.eventCoordinator=n;const o=new SessionCoordinator;o.initialize(),En.sessionCoordinator=o,mn({statusPanelContainer:e.statusPanelContainer,storageMonitorContainer:e.storageMonitorContainer,dbName:e.dbName,debug:e.debug}),!1!==e.autoEnhanceQuizTables&&function(){const e=document.querySelectorAll("table.qd-quiz");if(0===e.length)return void s("No quiz tables found to enhance");s(`Enhancing ${e.length} quiz table(s) in non-interactive mode...`);let t=0;for(const s of Array.from(e))try{J(s,{interactive:!1}),t++}catch(n){r(`Failed to enhance quiz table: ${n.message}`)}s(`Enhanced ${t} of ${e.length} quiz table(s) (non-interactive)`)}(),!1!==e.autoEnhanceAnalysisTables&&function(){const e=document.querySelectorAll("table.qd-analysis");if(0===e.length)return void s("No analysis tables found to enhance");s(`Enhancing ${e.length} analysis table(s) in non-interactive mode...`);let t=0;for(const s of Array.from(e))try{ae(s,{interactive:!1}),t++}catch(n){r(`Failed to enhance analysis table: ${n.message}`)}s(`Enhanced ${t} of ${e.length} analysis table(s) (non-interactive)`)}(),!1!==e.autoEnhanceHomeBadges&&function(){const e=document.querySelectorAll(".quizPageBtn");if(0===e.length)return void s("No .quizPageBtn links found, skipping badge enhancement");s(`Enhancing home page badges for ${e.length} link(s)...`);try{document.querySelectorAll(".quizPageBtn").forEach(e=>{const t=function(e){const t=e.getAttribute("href");return t&&t.substring(t.lastIndexOf("/")+1).replace(/\.html?$/i,"")||null}(e);t?(e.setAttribute("data-page-id",t),s(`Set data-page-id="${t}" for link: ${e.textContent?.trim()}`)):s(`Failed to extract pageId from href: ${e.getAttribute("href")}`)}),yn(),document.addEventListener("qd:state-changed",xn),document.addEventListener("qd:cache-rebuild",wn),document.addEventListener("qd:logout",Sn),s("Home page badges enhanced with event listeners"),s("Home page badges enhanced")}catch(t){r(`Failed to enhance home badges: ${t.message}`)}}(),await async function(){const e=S(l.SESSION);if(!e)return void s("No existing session, tables remain in non-interactive mode");if("true"===sessionStorage.getItem(l.INSTRUCTOR)){s("Instructor session detected, revealing answers in non-interactive tables");const e=window.location.pathname,t=e.substring(e.lastIndexOf("/")+1).replace(/\.html?$/i,"");return void document.querySelectorAll("table.qd-quiz").forEach(e=>{const n=Z(e);if(!n)return;n.pageId=t;e.querySelectorAll("td:nth-child(2), th:nth-child(2)").forEach(e=>{e.classList.remove("qd-hidden")});e.querySelectorAll("tbody td:nth-child(2)").forEach((e,t)=>{const s=n.parsed.questions[t];s&&e instanceof HTMLTableCellElement&&(e.textContent=s.correctAnswer)});e.querySelectorAll("td:nth-child(3), th:nth-child(3)").forEach(e=>e.classList.remove("qd-hidden"));const s=()=>{X(e,n)},o=()=>{ee(e)};document.addEventListener("qd:instructor-show-answers",s),document.addEventListener("qd:instructor-hide-answers",o);"true"===sessionStorage.getItem("qd/instructor/showAnswers")&&s()})}s(`Existing session detected for ${e.serviceId}, upgrading tables to interactive mode`);const t=F();let n=S(l.CACHE);if(!n){s("Cache not found, rebuilding from IndexedDB...");try{const o=await t.loadStudentRecord(e);n=t.buildCache(o),E(l.CACHE,n),s(`Cache rebuilt from IndexedDB: ${n.totals.total} total questions`)}catch{r("Failed to rebuild cache from IndexedDB, using empty cache"),n={totals:{total:0,answered:0,correct:0},pages:{}},E(l.CACHE,n)}}const o=window.location.pathname,a=o.substring(o.lastIndexOf("/")+1).replace(/\.html?$/i,"");if(!a)return void s("No pageId found, skipping table upgrade");const d=document.querySelectorAll("table.qd-quiz");d.length>0&&(s(`Upgrading ${d.length} quiz table(s) to interactive mode...`),d.forEach(e=>{J(e,{interactive:!0,pageId:a})}));const c=document.querySelectorAll("table.qd-analysis");c.length>0&&(s(`Upgrading ${c.length} analysis table(s) to interactive mode...`),c.forEach(e=>{ae(e,{interactive:!0,pageId:a})}))}(),En.initialized=!0,s("Bootstrap complete")}if("undefined"!=typeof window){const e=()=>{s("Auto-initializing Sonar Quiz System");const e=function(){s("Reading configuration from DOM...");const e={statusPanelContainer:wt(bt,pt),titleSelector:wt(vt,gt),instructorHash:wt(yt,mt),dbName:wt(xt,ft)};return s("Configuration loaded:",e),e}();Cn({debug:true,dbName:e.dbName,statusPanelContainer:e.statusPanelContainer,autoEnhanceQuizTables:!0,autoEnhanceAnalysisTables:!0,autoEnhanceHomeBadges:!0}).catch(e=>{console.error("[FATAL] Bootstrap failed:",e)})};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{e()}):e()}return e.BUILD_DATE="21/Nov/2025",e.DEFAULT_CONTAINERS=gn,e.Debouncer=Debouncer,e.SCHEMA_VERSION=2,e.SESSION_TIMEOUT_MS=c,e.STORAGE_KEYS=l,e.VERSION="0.1.0-phase3.1",e.bootstrap=Cn,e.calculateCompletionState=B,e.cleanup=function(){En.initialized?(s("Cleaning up bootstrap resources..."),En.eventCoordinator?.cleanup(),En.sessionCoordinator?.cleanup(),En.initialized=!1,En.eventCoordinator=void 0,En.sessionCoordinator=void 0,s("Bootstrap cleanup complete")):r("Bootstrap not initialized, nothing to cleanup")},e.clearQuizData=C,e.enhanceAnalysisTable=ae,e.enhanceQuizTable=J,e.error=o,e.generateCellKey=se,e.generateTableId=ne,e.getAnalysisTableMetadata=function(e){return ie.get(e)},e.getJSON=S,e.getQuizTableMetadata=Z,e.info=s,e.injectComponents=mn,e.isAnalysisTableEnhanced=function(e){return ie.has(e)},e.isCellEditable=oe,e.isInitialized=function(){return En.initialized},e.isQuizTableEnhanced=function(e){return K.has(e)},e.parseAnalysisTable=re,e.parseQuizTable=a,e.setJSON=E,e.validateAnswer=d,e.warn=r,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),e}({});
