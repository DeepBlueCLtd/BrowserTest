...
/**
  ...
  `,Kt([ht({type:Boolean,reflect:!0})],Wt.prototype,"open",2),Kt([ht({type:String})],Wt.prototype,"title",2),Kt([ht({type:String})],Wt.prototype,"message",2),Kt([ht({type:String})],Wt.prototype,"confirmText",2),Kt([ht({type:String})],Wt.prototype,"cancelText",2),Kt([ht({type:Boolean})],Wt.prototype,"destructive",2),Wt=Kt([ct("qd-confirm-dialog")],Wt);var Jt=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,Gt=(t,n,s,o)=>{for(var r,a=o>1?void 0:o?Yt(n,s):n,d=t.length-1;d>=0;d--)(r=t[d])&&(a=(o?r(n,s,a):r(a))||a);return o&&a&&Jt(n,s,a),a};let Zt=class extends at{constructor(){super(...arguments),this.panelType="login",this.handleClick=()=>{this.dispatchEvent(new CustomEvent("qd:help-open",{detail:{panelType:this.panelType},bubbles:!0,composed:!0}))}}render(){return Ye`
      <button
        class="help-icon"
  ...
  `,ln([pt()],un.prototype,"total",2),ln([pt()],un.prototype,"correct",2),ln([pt()],un.prototype,"percentage",2),ln([pt()],un.prototype,"statusColor",2),ln([pt()],un.prototype,"name",2),ln([pt()],un.prototype,"serviceId",2),ln([pt()],un.prototype,"helpOpen",2),un=ln([ct("qd-status")],un);const hn=me`
  :host {
    display: inline-block;
    font-family:
      system-ui,
