...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */const ge=".wh_top_menu_and_indexterms_link",me=".wh_publication_title .title",fe="",be="qd-status-container",ve="qd-title-selector",we="qd-instructor-hash",ye="qd-db-name";function Se(t,s){const n=document.querySelector(`#${t}`);if(!n)return s;const o=n.textContent?.trim()||"";return""===o?(a(`Config element #${t} found but empty, using default: "${s}"`),s):o}function xe(){const t=function(t){const s=document.querySelector(`#${t}`);if(!s){const s=`FATAL: Required config element #${t} not found in DOM. Processing stopped.`;throw console.error(s),new Error(s)}const n=s.textContent?.trim()||"";if(""===n){const s=`FATAL: Required config element #${t} is empty. Processing stopped.`;throw console.error(s),new Error(s)}return n}(ye);return{statusPanelContainer:Se(be,ge),titleSelector:Se(ve,me),instructorHash:Se(we,fe),dbName:t}}async function Ee(t){const s=(new TextEncoder).encode(t),n=await crypto.subtle.digest("SHA-256",s);return Array.from(new Uint8Array(n)).map(t=>t.toString(16).padStart(2,"0")).join("")}function $e(t){return`${u.PIN_ATTEMPTS}:${t}`}function Ie(t){const s=$e(t),n=sessionStorage.getItem(s);if(!n)return null;try{return JSON.parse(n)}catch{return null}}function Ce(t){const s=Ie(t);if(!s||!s.lockoutUntil)return{isLocked:!1,remainingMs:0};const n=new Date(s.lockoutUntil).getTime(),o=Date.now();return n>o?{isLocked:!0,remainingMs:n-o}:(Ae(t),{isLocked:!1,remainingMs:0})}function Ae(t){const n=Ie(t);n&&n.attempts>0&&(n.attempts,s(t));const o=$e(t);sessionStorage.removeItem(o)}var qe=Object.getOwnPropertyDescriptor;let ke=class extends ae{render(){return Yt`
  ...
  `,ke=((t,s,n,o)=>{for(var r,a=o>1?void 0:o?qe(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=r(a)||a);return a})([de("qd-build-info")],ke);var Te=Object.defineProperty,_e=Object.getOwnPropertyDescriptor,Pe=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?_e(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&Te(s,n,a),a};let Oe=null,Ne=class extends ae{constructor(){super(...arguments),this.open=!1,this.closable=!0,this.previouslyFocused=null,this.handleKeyDown=t=>{"Escape"===t.key&&this.open&&this.closable&&(this.emitCloseEvent(),this.close())},this.handleBackdropClick=()=>{this.closable&&(this.emitCloseEvent(),this.close())},this.handleCloseClick=()=>{this.emitCloseEvent(),this.close()},this.stopPropagation=t=>{t.stopPropagation()}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleKeyDown),Oe===this&&(Oe=null)}updated(t){t.has("open")&&(this.open?this.handleOpen():this.handleClose())}render(){return Yt`
  ...
  `,Pe([he({type:Boolean,reflect:!0})],Ne.prototype,"open",2),Pe([he({type:Boolean})],Ne.prototype,"closable",2),Ne=Pe([de("qd-modal")],Ne);var Le=Object.defineProperty,De=Object.getOwnPropertyDescriptor,Re=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?De(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&Le(s,n,a),a};let ze=class extends ae{constructor(){super(...arguments),this.open=!1,this.title="Enter Password",this.error="",this.password="",this.handleModalClose=()=>{this.close()},this.handleInput=t=>{const s=t.target;this.password=s.value,this.error&&(this.error="")},this.handleSubmit=t=>{t.preventDefault(),this.password.trim()&&this.dispatchEvent(new CustomEvent("qd:password-submit",{detail:{password:this.password},bubbles:!0,composed:!0}))},this.handleCancel=()=>{this.close()}}show(){this.open=!0,this.password="",this.error=""}close(){this.open=!1,this.password="",this.error="",this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}updated(t){t.has("open")&&this.open&&(this.password="",this.updateComplete.then(()=>{this.passwordInput?.focus()}))}render(){return this.open?Yt`
...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */class e extends i{constructor(t){if(super(t),this.it=Zt,t.type!==He)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Zt||null==t)return this._t=void 0,this.it=t;if(t===Gt)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const s=[t];return s.raw=s,this._t={_$litType$:this.constructor.resultType,strings:s,values:[]}}}e.directiveName="unsafeHTML",e.resultType=1;const Ue=(t=>(...s)=>({_$litDirective$:t,values:s}))(e);var je=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,Fe=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?Be(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&je(s,n,a),a};let Ve=class extends ae{constructor(){super(...arguments),this.open=!1,this.title="Confirm",this.message="",this.confirmText="Confirm",this.cancelText="Cancel",this.destructive=!1,this.handleModalClose=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:cancel",{bubbles:!0,composed:!0}))},this.handleConfirm=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:confirm",{bubbles:!0,composed:!0}))},this.handleCancel=()=>{this.close(),this.dispatchEvent(new CustomEvent("qd:cancel",{bubbles:!0,composed:!0}))}}show(){this.open=!0}close(){this.open=!1}render(){return Yt`
      <qd-modal .open=${this.open} @qd:modal-close=${this.handleModalClose}>
        <span slot="header">${this.title}</span>
  ...
  `,Fe([he({type:Boolean,reflect:!0})],Ve.prototype,"open",2),Fe([he({type:String})],Ve.prototype,"title",2),Fe([he({type:String})],Ve.prototype,"message",2),Fe([he({type:String})],Ve.prototype,"confirmText",2),Fe([he({type:String})],Ve.prototype,"cancelText",2),Fe([he({type:Boolean})],Ve.prototype,"destructive",2),Ve=Fe([de("qd-confirm-dialog")],Ve);var Qe=Object.defineProperty,Ke=Object.getOwnPropertyDescriptor,We=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?Ke(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&Qe(s,n,a),a};let Je=class extends ae{constructor(){super(...arguments),this.title="Sonar Quiz System",this.name="",this.serviceId="",this.showInstructorModal=!1,this.instructorError="",this.errorMessage="",this.isSubmitting=!1,this.pin="",this.lockoutSeconds=0,this.showPinConfirmation=!1,this.lockoutInterval=null,this.handleLogoutEvent=()=>{this.name="",this.serviceId="",this.errorMessage="",this.isSubmitting=!1,this.showInstructorModal=!1,this.instructorError="",this.pin="",this.lockoutSeconds=0,this.showPinConfirmation=!1,this.lockoutInterval&&(clearInterval(this.lockoutInterval),this.lockoutInterval=null),this.updateVisibility()},this.handleInstructorPasswordSubmit=t=>{this.handleInstructorLogin(t.detail.password)},this.handleInstructorModalClose=()=>{this.showInstructorModal=!1,this.instructorError=""},this.handlePinConfirmationDismiss=()=>{this.showPinConfirmation=!1}}connectedCallback(){super.connectedCallback(),this.updateVisibility(),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:logout",this.handleLogoutEvent),this.lockoutInterval&&(clearInterval(this.lockoutInterval),this.lockoutInterval=null)}firstUpdated(){this.setAttribute("data-ready","")}updateVisibility(){$(u.SESSION)?this.removeAttribute("data-show"):this.setAttribute("data-show","")}render(){return Yt`
  ...
  `,Ze([pe()],Xe.prototype,"total",2),Ze([pe()],Xe.prototype,"correct",2),Ze([pe()],Xe.prototype,"percentage",2),Ze([pe()],Xe.prototype,"statusColor",2),Ze([pe()],Xe.prototype,"name",2),Ze([pe()],Xe.prototype,"serviceId",2),Xe=Ze([de("qd-status")],Xe);const ts=gt`
  :host {
    display: inline-block;
    font-family:
      system-ui,
...
`;class RateLimiter{constructor(){this.failureCount=0,this.lockoutUntil=null}attempt(){return!(this.lockoutUntil&&Date.now()<this.lockoutUntil)&&(this.lockoutUntil&&Date.now()>=this.lockoutUntil&&(this.lockoutUntil=null),!0)}recordFailure(){this.failureCount++;const t=[2e3,4e3,8e3,16e3,3e4],s=t[Math.min(this.failureCount-1,t.length-1)]??3e4;this.lockoutUntil=Date.now()+s}reset(){this.failureCount=0,this.lockoutUntil=null}getRemainingSeconds(){if(!this.lockoutUntil)return 0;const t=Math.max(0,this.lockoutUntil-Date.now());return Math.ceil(t/1e3)}isLockedOut(){return null!==this.lockoutUntil&&Date.now()<this.lockoutUntil}}const es="instructor.password.hash";var ss=Object.defineProperty,ns=Object.getOwnPropertyDescriptor,os=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?ns(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&ss(s,n,a),a};let rs=class extends ae{constructor(){super(...arguments),this.password="",this.error="",this.remainingSeconds=0,this.rateLimiter=new RateLimiter,this.handlePasswordInput=t=>{const s=t.target;this.password=s.value,this.error=""},this.handleSubmit=async t=>{t.preventDefault();if(!this.rateLimiter.attempt())return this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),this.startCountdown(),void(this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`);try{const t=function(){const t=document.getElementById(es);if(!t){const t=`Instructor password hash not found. Expected element with id="${es}". Check Oxygen XSL transform configuration.`;throw r(t),new Error(t)}const s=t.textContent?.trim();if(!s){const t="Instructor password hash element is empty. Check Oxygen parameter configuration.";throw r(t),new Error(t)}if(!/^[a-f0-9]{64}$/i.test(s)){const t=`Invalid password hash format. Expected 64 hex characters (SHA-256), got: ${s.substring(0,20)}...`;throw r(t),new Error(t)}return s.toLowerCase()}(),s=(new TextEncoder).encode(this.password),n=await crypto.subtle.digest("SHA-256",s),o=Array.from(new Uint8Array(n)).map(t=>t.toString(16).padStart(2,"0")).join(""),a=await async function(t,s){if(t.length!==s.length)return!1;if(0===t.length)return!0;const n=new TextEncoder,o=n.encode(t),r=n.encode(s);try{const t=await crypto.subtle.importKey("raw",o,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),s=await crypto.subtle.sign("HMAC",t,r),n=await crypto.subtle.importKey("raw",r,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),a=await crypto.subtle.sign("HMAC",n,o);if(s.byteLength!==a.byteLength)return!1;const c=new Uint8Array(s),d=new Uint8Array(a);let l=0;for(let o=0;o<c.length;o++)l|=(c[o]??0)^(d[o]??0);return 0===l}catch(a){return console.error("Constant-time comparison failed:",a),!1}}(o,t);a?(this.rateLimiter.reset(),this.password="",this.error="",E(this,"qd:instructor-unlock",{})):(this.error="Invalid password",this.password="")}catch{this.error="Authentication failed",this.password=""}}}disconnectedCallback(){super.disconnectedCallback(),this.countdownInterval&&window.clearInterval(this.countdownInterval)}startCountdown(){this.countdownInterval&&window.clearInterval(this.countdownInterval),this.countdownInterval=window.setInterval(()=>{this.remainingSeconds=this.rateLimiter.getRemainingSeconds(),0===this.remainingSeconds?(this.countdownInterval&&(window.clearInterval(this.countdownInterval),this.countdownInterval=void 0),this.error=""):this.error=`Too many attempts. Try again in ${this.remainingSeconds}s`},1e3)}render(){const t=this.remainingSeconds>0;return Yt`
    ...
    `}};rs.styles=ts,os([pe()],rs.prototype,"password",2),os([pe()],rs.prototype,"error",2),os([pe()],rs.prototype,"remainingSeconds",2),rs=os([de("qd-instructor-unlock")],rs);var is=Object.defineProperty,as=Object.getOwnPropertyDescriptor,cs=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?as(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&is(s,n,a),a};let ds=class extends ae{constructor(){super(...arguments),this.open=!1,this.students=[],this.expandedStudents=new Set,this.handleModalClose=()=>{this.open=!1,this.dispatchEvent(new CustomEvent("close"))}}updated(t){t.has("open")&&this.open&&(this.expandedStudents=new Set(this.students.map(t=>t.serviceId)))}render(){return Yt`
      <qd-modal .open=${this.open} @qd:modal-close=${this.handleModalClose}>
  ...
  `,cs([he({type:Boolean,reflect:!0})],ds.prototype,"open",2),cs([he({type:Array})],ds.prototype,"students",2),cs([pe()],ds.prototype,"expandedStudents",2),ds=cs([de("qd-scores-modal")],ds);var ls=Object.defineProperty,us=Object.getOwnPropertyDescriptor,hs=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?us(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&ls(s,n,a),a};let ps=class extends ae{constructor(){super(...arguments),this.students=[],this.showModal=!1,this.handleClose=()=>{this.dispatchEvent(new CustomEvent("close"))}}render(){return Yt`
    ...
    `}};bs.styles=ts,fs([he({type:Array})],bs.prototype,"students",2),bs=fs([de("qd-instructor-export")],bs);var vs=Object.defineProperty,ws=Object.getOwnPropertyDescriptor,ys=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?ws(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&vs(s,n,a),a};let Ss=class extends ae{constructor(){super(...arguments),this.showConfirmDialog=!1,this.confirmText="",this.error="",this.success="",this.modalContainer=null,this.handleClearRequest=()=>{this.showConfirmDialog=!0,this.confirmText="",this.error="",this.success=""},this.handleCancelClear=()=>{this.showConfirmDialog=!1,this.confirmText="",this.error=""},this.handleConfirmInput=t=>{const s=t.target;this.confirmText=s.value},this.handleConfirmClear=()=>{if("DELETE ALL DATA"===this.confirmText)try{A(),E(this,"qd:data-cleared",{}),this.success="All quiz data cleared successfully",this.showConfirmDialog=!1,this.confirmText="",this.error="",setTimeout(()=>{this.success=""},3e3)}catch{this.error="Failed to clear data"}else this.error="Confirmation text does not match"}}disconnectedCallback(){super.disconnectedCallback(),this.removeModalFromBody()}updated(t){super.updated(t),t.has("showConfirmDialog")&&(this.showConfirmDialog?this.renderModalToBody():this.removeModalFromBody()),this.showConfirmDialog&&(t.has("confirmText")||t.has("error"))&&this.renderModalToBody()}renderModalToBody(){this.modalContainer||(this.modalContainer=document.createElement("div"),this.modalContainer.className="qd-manage-modal-container",document.body.appendChild(this.modalContainer)),re(this.renderConfirmDialog(),this.modalContainer)}removeModalFromBody(){this.modalContainer&&(this.modalContainer.remove(),this.modalContainer=null)}render(){return Yt`
      <button
  ...
  `,$s([he({type:Array})],Is.prototype,"students",2),$s([he({type:Boolean,reflect:!0})],Is.prototype,"open",2),$s([pe()],Is.prototype,"searchText",2),$s([pe()],Is.prototype,"confirmingStudent",2),$s([pe()],Is.prototype,"confirmDialogOpen",2),$s([pe()],Is.prototype,"errorMessage",2),$s([he({type:Boolean})],Is.prototype,"showModal",1),Is=$s([de("qd-pin-reset-dialog")],Is);var Cs=Object.defineProperty,As=Object.getOwnPropertyDescriptor,qs=(t,s,n,o)=>{for(var r,a=o>1?void 0:o?As(s,n):s,c=t.length-1;c>=0;c--)(r=t[c])&&(a=(o?r(s,n,a):r(a))||a);return o&&a&&Cs(s,n,a),a};let ks=class extends ae{constructor(){super(...arguments),this.unlocked=!1,this.showScores=!1,this.students=[],this.showStudentAnswers=!1,this.showPinReset=!1,this.handleLoginEvent=t=>{const s=t,n=s.detail?.role;this.updateVisibility(),"instructor"===n&&this.unlock()},this.handleLogoutEvent=()=>{this.updateVisibility(),this.lock()},this.handleResetPins=async()=>{const t=$(u.SESSION);if(t){try{const{getStorageService:s}=await Promise.resolve().then(()=>Q),n=s(),o=await n.getStudentsByRelease(t.release);this.students=o}catch(s){console.error("Failed to load students:",s),this.students=[]}this.showPinReset=!0}},this.handleClosePinReset=()=>{this.showPinReset=!1},this.handlePinReset=()=>{this.dispatchEvent(new CustomEvent("qd:pin-reset",{bubbles:!0,composed:!0}))},this.handleUnlock=()=>{this.unlocked=!0,this.dispatchEvent(new CustomEvent("qd:instructor-unlock",{bubbles:!0,composed:!0}))},this.handleViewScores=async()=>{const t=$(u.SESSION);if(t){try{const{getStorageService:s}=await Promise.resolve().then(()=>Q),n=s(),o=await n.getStudentsByRelease(t.release);this.students=o}catch(s){console.error("Failed to load students:",s),this.students=[]}this.showScores=!0}},this.handleCloseScores=()=>{this.showScores=!1},this.handleDataCleared=()=>{this.dispatchEvent(new CustomEvent("qd:data-cleared",{bubbles:!0,composed:!0})),this.students=[]},this.handleLogout=()=>{const t=$(u.SESSION);(new SessionService).clearSession(),this.dispatchEvent(new CustomEvent("qd:logout",{detail:{serviceId:t?.serviceId||"unknown"},bubbles:!0,composed:!0}))},this.handleToggleStudentAnswers=async t=>{const s=t.target;if(this.showStudentAnswers=s.checked,this.showStudentAnswers&&0===this.students.length){const t=$(u.SESSION);if(t)try{const{getStorageService:s}=await Promise.resolve().then(()=>Q),n=s(),o=await n.getStudentsByRelease(t.release);this.students=o}catch(o){console.error("Failed to load students for toggle:",o)}}const n=this.showStudentAnswers?"qd:instructor-show-answers":"qd:instructor-hide-answers";this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0})),sessionStorage.setItem("qd/instructor/showAnswers",String(this.showStudentAnswers))}}connectedCallback(){super.connectedCallback(),this.updateVisibility();const t="true"===sessionStorage.getItem(u.INSTRUCTOR);t&&this.unlock();const s=sessionStorage.getItem("qd/instructor/showAnswers");null!==s&&(this.showStudentAnswers="true"===s,this.showStudentAnswers&&t&&setTimeout(()=>{this.dispatchEvent(new CustomEvent("qd:instructor-show-answers",{bubbles:!0,composed:!0}))},100)),document.addEventListener("qd:login",this.handleLoginEvent),document.addEventListener("qd:logout",this.handleLogoutEvent)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("qd:login",this.handleLoginEvent),document.removeEventListener("qd:logout",this.handleLogoutEvent)}updateVisibility(){"true"===sessionStorage.getItem(u.INSTRUCTOR)?this.setAttribute("data-show",""):this.removeAttribute("data-show")}setStudents(t){this.students=t}unlock(){this.unlocked=!0}lock(){this.unlocked=!1,this.showScores=!1,this.showPinReset=!1}render(){return this.unlocked?Yt`
    ...
    `],qs([pe()],ks.prototype,"unlocked",2),qs([pe()],ks.prototype,"showScores",2),qs([pe()],ks.prototype,"students",2),qs([pe()],ks.prototype,"showStudentAnswers",2),qs([pe()],ks.prototype,"showPinReset",2),ks=qs([de("qd-instructor")],ks);const Ts={statusPanel:".wh_top_menu_and_indexterms_link"};function _s(t={}){const s=t.statusPanelContainer||Ts.statusPanel;!function(t){const s=document.querySelector(t);if(!s)return null;const n=document.createElement("qd-login");s.appendChild(n)}(s),function(t){const s=document.querySelector(t);if(!s)return null;const n=document.createElement("qd-status");s.appendChild(n)}(s),function(t){const s=document.querySelector(t);if(!s)return null;const n=document.createElement("qd-instructor");s.appendChild(n)}(s)}const Ps={red:"qd-badge-red",amber:"qd-badge-amber",green:"qd-badge-green"},Os={unstarted:"red",incomplete:"amber",complete:"green"};function Ns(t){const s=function(t,s){if(!t||!s?.pages)return"unstarted";const n=s.pages[t];return n?.state??"unstarted"}(t.getAttribute("data-page-id"),$(u.CACHE));!function(t,s){Object.values(Ps).forEach(s=>{t.classList.remove(s)});const n=Ps[Os[s]];t.classList.add(n)}(t,s)}function Ls(){const t=document.querySelectorAll(".quizPageBtn"),s=$(u.CACHE),n="true"===sessionStorage.getItem(u.INSTRUCTOR);if(!s||n)return t.forEach(t=>{Object.values(Ps).forEach(s=>{t.classList.remove(s)})}),void t.length;t.forEach(t=>{Ns(t)}),t.length}function Ds(t){const s=t,{pageId:n}=s.detail,o=document.querySelector(`[data-page-id="${n}"]`);o&&o.classList.contains("quizPageBtn")&&Ns(o)}function Rs(){Ls()}function zs(){const t=document.querySelectorAll(".quizPageBtn");t.forEach(t=>{Object.values(Ps).forEach(s=>{t.classList.remove(s)})}),t.length}const Ms={initialized:!1};async function Hs(t={}){if(Ms.initialized)return void a("Bootstrap already initialized, skipping");if(function(){if(document.getElementById("qd-global-styles"))return;const t=document.createElement("style");t.id="qd-global-styles",t.textContent="\n    /* Sonar Quiz System - Global Styles */\n    .qd-hidden {\n      display: none !important;\n    }\n\n    /* Quiz table interactive mode styles */\n    .qd-quiz-interactive .qd-quiz-input {\n      width: 100%;\n      padding: 0.5rem;\n      font-size: 1rem;\n      border: 1px solid #ccc;\n      border-radius: 4px;\n    }\n\n    /* Validation styling for answer cells */\n    .qd-quiz-interactive .qd-answer-correct {\n      background-color: #d4edda !important;\n      border-color: #28a745 !important;\n    }\n\n    .qd-quiz-interactive .qd-answer-incorrect {\n      background-color: #f8d7da !important;\n      border-color: #dc3545 !important;\n    }\n\n    /* Home page badge styles (R/A/G indicators) */\n    .qd-badge-red {\n      border-left: 4px solid #d32f2f !important;\n      background-color: #ffebee !important;\n    }\n\n    .qd-badge-amber {\n      border-left: 4px solid #ff9800 !important;\n      background-color: #fff3e0 !important;\n    }\n\n    .qd-badge-green {\n      border-left: 4px solid #4caf50 !important;\n      background-color: #e8f5e9 !important;\n    }\n\n    /* Instructor mode: Student answers display */\n    .qd-student-answers {\n      margin-top: 12px;\n      padding: 8px;\n      background: #f8f9fa;\n      border-radius: 4px;\n      border: 1px solid #dee2e6;\n    }\n\n    .qd-student-answer {\n      font-size: 12px;\n      padding: 4px 0;\n      line-height: 1.4;\n    }\n\n    .qd-student-answer.qd-correct {\n      color: #28a745;\n    }\n\n    .qd-student-answer.qd-incorrect {\n      color: #dc3545;\n    }\n\n    .qd-student-name {\n      font-weight: 600;\n    }\n\n    .qd-student-answer-text {\n      margin: 0 4px;\n    }\n\n    .qd-timestamp {\n      color: #6c757d;\n      font-size: 11px;\n      margin-left: 8px;\n    }\n  ",document.head.appendChild(t)}(),!t.dbName){const t="FATAL: dbName not provided in bootstrap config. Processing stopped.";throw console.error(t),new Error(t)}const s=V(t.dbName);await s.init();const n=new EventCoordinator;n.initialize(),Ms.eventCoordinator=n;const o=new SessionCoordinator;o.initialize(),Ms.sessionCoordinator=o,_s({statusPanelContainer:t.statusPanelContainer,dbName:t.dbName}),!1!==t.autoEnhanceQuizTables&&function(){const t=document.querySelectorAll("table.qd-quiz");if(0===t.length)return;t.length;for(const n of Array.from(t))try{W(n,{interactive:!1})}catch(s){a(`Failed to enhance quiz table: ${s.message}`)}t.length}(),!1!==t.autoEnhanceAnalysisTables&&function(){const t=document.querySelectorAll("table.qd-analysis");if(0===t.length)return;t.length;for(const n of Array.from(t))try{at(n,{interactive:!1})}catch(s){a(`Failed to enhance analysis table: ${s.message}`)}t.length}(),!1!==t.autoEnhanceHomeBadges&&function(){const t=document.querySelectorAll(".quizPageBtn");if(0===t.length)return;t.length;try{document.querySelectorAll(".quizPageBtn").forEach(t=>{const s=function(t){const s=t.getAttribute("href");return s&&s.substring(s.lastIndexOf("/")+1).replace(/\.html?$/i,"")||null}(t);s?(t.setAttribute("data-page-id",s),t.textContent?.trim()):t.getAttribute("href")}),Ls(),document.addEventListener("qd:state-changed",Ds),document.addEventListener("qd:cache-rebuild",Rs),document.addEventListener("qd:logout",zs)}catch(s){a(`Failed to enhance home badges: ${s.message}`)}}(),await async function(){const t=$(u.SESSION);if(!t)return;if("true"===sessionStorage.getItem(u.INSTRUCTOR)){const t=window.location.pathname,s=t.substring(t.lastIndexOf("/")+1).replace(/\.html?$/i,"");return void document.querySelectorAll("table.qd-quiz").forEach(t=>{const n=Z(t);if(!n)return;n.pageId=s;t.querySelectorAll("td:nth-child(2), th:nth-child(2)").forEach(t=>{t.classList.remove("qd-hidden")});t.querySelectorAll("tbody td:nth-child(2)").forEach((t,s)=>{const o=n.parsed.questions[s];o&&t instanceof HTMLTableCellElement&&(t.textContent=o.correctAnswer)});t.querySelectorAll("td:nth-child(3), th:nth-child(3)").forEach(t=>t.classList.remove("qd-hidden"));const o=()=>{X(t,n)},r=()=>{tt(t)};document.addEventListener("qd:instructor-show-answers",o),document.addEventListener("qd:instructor-hide-answers",r);"true"===sessionStorage.getItem("qd/instructor/showAnswers")&&o()})}t.serviceId;const s=V();let n=$(u.CACHE);if(!n)try{const o=await s.loadStudentRecord(t);n=s.buildCache(o),C(u.CACHE,n),n.totals.total}catch{a("Failed to rebuild cache from IndexedDB, using empty cache"),n={totals:{total:0,answered:0,correct:0},pages:{}},C(u.CACHE,n)}const o=window.location.pathname,r=o.substring(o.lastIndexOf("/")+1).replace(/\.html?$/i,"");if(!r)return;const c=document.querySelectorAll("table.qd-quiz");c.length>0&&(c.length,c.forEach(t=>{W(t,{interactive:!0,pageId:r})}));const d=document.querySelectorAll("table.qd-analysis");d.length>0&&(d.length,d.forEach(t=>{at(t,{interactive:!0,pageId:r})}))}(),Ms.initialized=!0}if("undefined"!=typeof window){const t=()=>{const t=xe();Hs({dbName:t.dbName,statusPanelContainer:t.statusPanelContainer,autoEnhanceQuizTables:!0,autoEnhanceAnalysisTables:!0,autoEnhanceHomeBadges:!0}).catch(t=>{console.error("[FATAL] Bootstrap failed:",t)})};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{t()}):t()}return t.BUILD_DATE="27/Nov/2025",t.DEFAULT_CONTAINERS=Ts,t.Debouncer=Debouncer,t.SCHEMA_VERSION=2,t.SESSION_TIMEOUT_MS=l,t.STORAGE_KEYS=u,t.VERSION="0.1.0-phase3.1",t.bootstrap=Hs,t.calculateCompletionState=j,t.cleanup=function(){Ms.initialized?(Ms.eventCoordinator?.cleanup(),Ms.sessionCoordinator?.cleanup(),Ms.initialized=!1,Ms.eventCoordinator=void 0,Ms.sessionCoordinator=void 0):a("Bootstrap not initialized, nothing to cleanup")},t.clearQuizData=A,t.enhanceAnalysisTable=at,t.enhanceQuizTable=W,t.error=r,t.generateCellKey=nt,t.generateTableId=st,t.getAnalysisTableMetadata=function(t){return it.get(t)},t.getJSON=$,t.getQuizTableMetadata=Z,t.info=o,t.injectComponents=_s,t.isAnalysisTableEnhanced=function(t){return it.has(t)},t.isCellEditable=ot,t.isInitialized=function(){return Ms.initialized},t.isQuizTableEnhanced=function(t){return K.has(t)},t.parseAnalysisTable=rt,t.parseQuizTable=c,t.setJSON=C,t.validateAnswer=d,t.warn=a,Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),t}({});
