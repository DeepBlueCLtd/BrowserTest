import{x as n}from"./lit-element-CSmQN0ht.js";import{e as u}from"./quiz-table-CSKOV5hk.js";import{S as d}from"./storage-helpers-BNoxrCtd.js";import"./iframe-DyU3bkDf.js";import"./session-Bx2jS3Yd.js";import"./date-helpers-DnOSSXb9.js";import"./event-helpers-DOv9sfVv.js";import"./storage-service-DCabG_JC.js";import"./indexeddb-CRFeaCTM.js";const I={title:"Enhancers/Quiz Table",tags:["autodocs"],parameters:{docs:{description:{component:"Single-phase quiz table enhancement. Shows non-interactive (pre-login) and interactive (post-login) modes."}}}},g=()=>n`
  <table class="qd-quiz">
    <thead>
      <tr>
        <th>Question</th>
...
Interactive demo showing state progression from unstarted → incomplete → complete`,...c.parameters?.docs?.description}}};const x=["NonInteractiveMode","InteractiveMCQ","InteractiveNumeric","WithExistingAnswers","StateProgression"];export{a as InteractiveMCQ,i as InteractiveNumeric,o as NonInteractiveMode,c as StateProgression,l as WithExistingAnswers,x as __namedExportsOrder,I as default};
